    ...
    <div className="min-h-screen bg-ink-50 dark:bg-ink-950 pb-20">
      ...
      <section className="bg-[#16284e] text-white relative py-4 px-3 sm:px-6 lg:px-8 border-b border-ink-700/60 z-20">
        ...
        <div className="max-w-7xl mx-auto relative z-20 space-y-3.5">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3 pb-1 border-b border-ink-800/60">
            <div>
              ...
              <h1 className="text-lg sm:text-xl font-black tracking-tight text-white leading-snug">
                CHỢ DỊCH VỤ & THỢ CƯ DÂN <span className="text-brand-400">VINHOMES</span>
              </h1>
              <p className="text-ink-300 text-xs mt-0.5 max-w-2xl">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-black bg-brand-600 hover:bg-brand-500 text-white shadow-md transition active:scale-95 cursor-pointer shrink-0"
            >
          ...
          <div className="w-full bg-brand-950/70 border border-brand-500/40 rounded-lg px-2.5 py-1.5 text-[11px] text-brand-200 flex items-center justify-between gap-2 shadow-inner">
            <span className="flex items-center gap-1.5 min-w-0">
              <span className="bg-brand-500/20 text-brand-300 font-black px-1.5 py-0.5 rounded text-[9px] border border-brand-500/30 uppercase shrink-0">
                 PHÍ SÀN 0%
              </span>
            ...
            <button 
              ...
              className="text-[9px] text-brand-300 underline hover:text-brand-200 font-bold shrink-0 flex items-center gap-0.5 cursor-pointer"
            >
              <AlertTriangle className="w-3 h-3 text-brand-400" />
              <span>Quy định Pháp lý</span>
            </button>
          </div>

          {/* Row 3: Action Buttons Bar - 2 tiện ích công khai */}
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-1.5 pt-1">
            {/* Xe Cư Dân 24/7 */}
            <button
              onClick={() => setIsTransportModalOpen(true)}
              className="px-2 py-1.5 rounded-lg bg-ink-800/90 hover:bg-ink-800 border border-brand-500/40 hover:border-brand-400 text-brand-300 shadow-sm transition active:scale-95 cursor-pointer flex items-center justify-center gap-1.5 group"
              title="Đặt Xe Vận Tải Nội & Ngoại Khu 24/7"
            >
              <Car className="w-3.5 h-3.5 shrink-0" />
              <span className="text-[10px] font-black text-white truncate group-hover:text-brand-300">Xe Cư Dân 24/7</span>
            </button>

            {/* Xây Lắp & Thang Máy */}
            <button
              onClick={() => setIsConstructionModalOpen(true)}
              className="px-2 py-1.5 rounded-lg bg-ink-800/90 hover:bg-ink-800 border border-blue-500/40 hover:border-blue-400 text-blue-300 shadow-sm transition active:scale-95 cursor-pointer flex items-center justify-center gap-1.5 group"
            ...
            {currentUser && (
              ...
              <button
                ...
                className="col-span-2 sm:col-span-3 lg:col-span-6 px-2 py-1.5 rounded-lg bg-gradient-to-r from-brand-950/80 to-ink-900 border border-brand-500/50 hover:border-brand-400 text-brand-300 shadow-sm transition active:scale-95 cursor-pointer flex items-center justify-between gap-2"
              ...
              >
                ...
                <span className="text-[9px] font-bold bg-brand-500/20 text-brand-300 px-1.5 py-0.5 rounded-md border border-brand-500/30 shrink-0">
                  Mở ví →
                </span>
              </button>
            )}
          ...
          <div className="bg-white dark:bg-ink-900 p-2 rounded-xl shadow-lg border border-ink-200 dark:border-ink-800">
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
              ...
              <div className="relative w-full sm:w-72 shrink-0 z-30">
                <button
                  ...
                  className="w-full flex items-center justify-between gap-2 px-3 py-2 bg-ink-100 dark:bg-ink-800 hover:bg-ink-200 dark:hover:bg-ink-700 text-ink-900 dark:text-white rounded-lg text-xs font-black border border-ink-200 dark:border-ink-700 transition cursor-pointer shadow-xs"
                >
                  ...
                  <ChevronDown className={`w-3.5 h-3.5 text-ink-400 transition-transform duration-200 ${isProjectDropdownOpen ? 'rotate-180' : ''}`} />
                </button>
                ...
                {isProjectDropdownOpen && (
                  <>
                    ...
                    />
                    <div className="absolute top-full left-0 right-0 sm:w-80 mt-1.5 bg-white dark:bg-ink-900 border border-ink-300 dark:border-ink-700 rounded-xl shadow-2xl z-50 p-3 space-y-2 animate-in fade-in slide-in-from-top-1 duration-150">
                      <div className="text-[11px] font-black text-ink-500 dark:text-ink-400 uppercase tracking-wider px-1 flex items-center justify-between">
                        <span>CHỌN DỰ ÁN VINHOMES</span>
                        <button onClick={() => setIsProjectDropdownOpen(false)} className="text-ink-400 hover:text-ink-700 dark:hover:text-ink-200 p-1 cursor-pointer">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-8 pr-3 py-1.5 bg-ink-50 dark:bg-ink-800 text-ink-900 dark:text-white rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-brand-500 border border-ink-200 dark:border-ink-700 font-bold"
                        autoFocus
                      />
                    </div>
                        ...
                        <button
                          ...
                          className={`px-2 py-0.5 font-bold text-[10px] rounded-md border transition cursor-pointer ${
                            selectedProject === chip.id
                              ? 'bg-brand-500 text-ink-950 border-brand-400 font-black'
                    ...
                    {/* Options List */}
                    <div className="max-h-64 overflow-y-auto space-y-1 pr-1 scrollbar-thin bg-white dark:bg-ink-900">
                      <button
                        onClick={() => {
                        ...
                        className={`w-full text-left px-2.5 py-1.5 rounded-lg text-xs font-bold transition flex items-center justify-between cursor-pointer border ${
                          selectedProject === 'all'
                            ...
                            : 'bg-ink-100 dark:bg-ink-800 border-ink-200 dark:border-ink-700 hover:bg-ink-200 dark:hover:bg-ink-700 text-ink-800 dark:text-ink-200'
                        }`}
                      >
                        <span className="flex items-center gap-2">
                          <Building2 className="w-3.5 h-3.5 text-brand-500 dark:text-brand-400 shrink-0" />
                          <span className="truncate"> Tất Cả Dự Án Vinhomes (Toàn Quốc)</span>
                        </span>
                        <span className="text-[10px] bg-brand-500/20 text-brand-800 dark:text-brand-300 px-1.5 py-0.5 rounded-full font-black shrink-0">
                          {services.length}
                        </span>
                      </button>
                          ...
                          >
                            <div className="flex items-center justify-between gap-1">
                              <span className="flex items-center gap-1.5 font-extrabold truncate">
                                <MapPin className={`w-3.5 h-3.5 shrink-0 ${isSelected ? 'text-brand-300' : 'text-brand-500'}`} />
                                <span className="truncate">{proj.name}</span>
                              </span>
                              <span className={`text-[10px] font-black px-1.5 py-0.2 rounded-full shrink-0 ${
                                isSelected ? 'bg-white/20 text-white' : 'bg-brand-500/20 text-brand-700 dark:text-brand-300'
                              }`}>
                                {count} dịch vụ
                              </span>
                            </div>
                            ...
                            <div className="flex items-center justify-between text-[10px] opacity-80 pl-5">
                              ...
                              <span className={`px-1.5 py-0.2 rounded ${isSelected ? 'bg-brand-400/30 text-brand-200' : 'bg-ink-200 dark:bg-ink-700 text-ink-700 dark:text-ink-300'}`}>
                                {proj.tag}
                              </span>
                            </div>
                          </button>
              ...
              <div className="relative flex-1 w-full space-y-1.5">
                <div className="relative">
                  <Search className="w-4 h-4 absolute left-3 top-1/2 -translate-y-1/2 text-brand-500 font-black" />
                  <input
                    type="text"
                    value={searchQuery}
                    onChange={(e) => setSearchQuery(e.target.value)}
                    placeholder="Tìm dịch vụ, món ăn, thợ cư dân (VD: Bún chả, Thang máy, Taxi, Spa...)"
                    className="w-full pl-9 pr-20 py-2 bg-ink-50 dark:bg-ink-800 text-ink-900 dark:text-white rounded-xl text-xs font-bold focus:outline-none focus:ring-2 focus:ring-brand-500 border border-ink-200 dark:border-ink-700 shadow-inner"
                  />
                  {searchQuery ? (
                    <button
                      type="button"
                      onClick={() => setSearchQuery('')}
                      className="absolute right-2 top-1/2 -translate-y-1/2 px-2 py-0.5 bg-ink-200 dark:bg-ink-700 hover:bg-rose-500 hover:text-white text-ink-700 dark:text-ink-300 rounded-lg text-[11px] font-bold transition flex items-center gap-1 cursor-pointer"
                    >
                      <X className="w-3 h-3" />
                      <span>Xóa</span>
                    </button>
                  ) : (
                    <span className="absolute right-2.5 top-1/2 -translate-y-1/2 text-[9px] font-black text-brand-500 bg-brand-500/10 px-1.5 py-0.5 rounded border border-brand-500/20 pointer-events-none hidden sm:inline-block">
                       AI Search
                    </span>
                  )}
                </div>
                ...
                <div className="flex flex-wrap items-center justify-between gap-1 px-1">
                  <div className="flex flex-wrap items-center gap-1">
                    <span className="text-[10px] font-black text-brand-500 uppercase flex items-center gap-1">
                       Gợi Ý:
                    </span>
                    {[
                      'Cơm Cư Dân',
                      ...
                      <button
                        ...
                        className={`px-1.5 py-0.5 rounded-md text-[10px] font-bold transition cursor-pointer ${
                          searchQuery === tag
                            ? 'bg-brand-500 text-ink-950 font-black shadow-xs ring-1 ring-brand-400'
                            : 'bg-ink-100 dark:bg-ink-800/80 text-ink-600 dark:text-ink-300 hover:bg-ink-200 dark:hover:bg-ink-700 border border-ink-200/80 dark:border-ink-700/80'
                        }`}
                      >
                        {tag}
                      </button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 space-y-6">
            ...
            <button
              ...
              >
                ...
                <div className="min-w-0 w-full">
                  ...
                  <div className="text-[9px] text-ink-400 truncate">{stores.length} gian hàng</div>
                </div>
              </button>
              ...
              return (
                ...
                >
                  ...
                  {industryRule?.isStrictMandatory && (
                    <span className={`hidden lg:inline-block w-1.5 h-1.5 rounded-full shrink-0 ${isActive ? 'bg-brand-300' : 'bg-brand-500'}`} title="Yêu cầu giấy phép ngành nghề" />
                  )}
                </button>
              );
            })}
          ...
          {expandedCatId && (
            <div className="lg:hidden bg-white dark:bg-ink-900 border border-brand-500/40 rounded-2xl shadow-lg overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
              <div className="px-3 py-2.5 bg-brand-600/10 border-b border-brand-500/30 flex items-center justify-between gap-2">
                <div className="flex items-center gap-2 min-w-0">
                  <span className="p-1.5 rounded-xl bg-brand-500/15 text-brand-600 dark:text-brand-400 shrink-0">
                    {expandedCatId === 'all'
                      ? <Wrench className="w-4 h-4" />
                      : renderCategoryIcon(RESIDENT_SERVICE_CATEGORIES.find(c => c.id === expandedCatId)?.iconName || 'wrench', "w-4 h-4")}
                  </span>
                  <div className="min-w-0">
                    <div className="text-xs font-black text-ink-900 dark:text-white truncate">
                      {expandedCatId === 'all' ? 'Tất Cả Dịch Vụ' : RESIDENT_SERVICE_CATEGORIES.find(c => c.id === expandedCatId)?.name}
                    </div>
                    <div className="text-[9px] text-ink-500 dark:text-ink-400">
                ...
                <button
                  ...
                  className="p-1.5 bg-ink-100 dark:bg-ink-800 text-ink-500 dark:text-ink-300 rounded-lg hover:bg-ink-200 dark:hover:bg-ink-700 cursor-pointer shrink-0"
                  title="Đóng khung"
                >
                  <X className="w-3.5 h-3.5" />
                </button>
              ...
              <div className="p-3 space-y-2 max-h-[50vh] overflow-y-auto">
                {(expandedCatId === 'all' ? services : services.filter(s => s.categoryId === expandedCatId)).slice(0, 6).map(s => (
                  <button
                    ...
                    className="w-full text-left bg-ink-50 dark:bg-ink-800/60 rounded-xl px-3 py-2 flex items-center justify-between gap-2 hover:bg-brand-500/10 transition cursor-pointer"
                  >
                    <div className="min-w-0">
                ...
                {(expandedCatId === 'all' ? services : services.filter(s => s.categoryId === expandedCatId)).length === 0 && (
                  <div className="text-center py-6 space-y-2">
                    ...
                    <div className="text-[11px] text-ink-500 dark:text-ink-400 font-bold">Chưa có dịch vụ nào trong danh mục này</div>
                    <button
                      onClick={() => setIsPostingModalOpen(true)}
                      className="px-3 py-1.5 bg-brand-500 hover:bg-brand-400 text-ink-950 font-black text-[10px] rounded-xl cursor-pointer"
                    >
                      + Đăng Bài Dịch Vụ
                    </button>
                  </div>
                ...
                {(expandedCatId === 'all' ? services : services.filter(s => s.categoryId === expandedCatId)).length > 6 && (
                  <button
                    ...
                    className="w-full py-2 bg-brand-600 hover:bg-brand-500 text-white font-black text-[11px] rounded-xl cursor-pointer"
                  >
                    Xem tất cả →
                  </button>
                )}
          ...
          {selectedCategoryObj && (
            <div className="bg-white dark:bg-ink-900 p-3 rounded-2xl border border-ink-200 dark:border-ink-800 space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-[11px] font-black text-ink-400 uppercase tracking-wider">
                  Dịch vụ chi tiết thuộc: <strong className="text-brand-600 dark:text-brand-400">{selectedCategoryObj.name}</strong>
                </span>
          ...
          <div id="gian-hang-cu-dan" className="bg-white dark:bg-ink-900 border border-ink-200 dark:border-ink-800 rounded-3xl p-4 sm:p-5 shadow-xl space-y-4 scroll-mt-20">
            
            {/* Consolidated Title & Header Action Controls */}
            <div className="space-y-2.5 border-b border-ink-100 dark:border-ink-800 pb-3">
              <div className="flex items-center justify-between gap-3">
                <div className="min-w-0 flex-1">
                  <h2 className="text-sm sm:text-lg font-black text-ink-900 dark:text-white tracking-tight leading-snug">
                     Gian Hàng Cư Dân &amp; Đối Tác Dịch Vụ
                  </h2>
                  <p className="text-[11px] text-ink-500 dark:text-ink-400 leading-snug mt-0.5">
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-brand-500 hover:bg-brand-400 text-ink-950 font-black text-[11px] rounded-xl shadow-xs transition flex items-center justify-center gap-1 cursor-pointer shrink-0"
                >
              ...
              <div className="flex items-center justify-start gap-2">
                <div className="flex items-center bg-ink-100 dark:bg-ink-800 p-0.5 rounded-xl border border-ink-200 dark:border-ink-700/80 max-w-full overflow-x-auto scrollbar-none">
                  <button
                  ...
                  >
                    <ShieldCheck className="w-3.5 h-3.5 text-brand-200 shrink-0" />
                    <span> Đã Định Danh ({totalVerified})</span>
                  </button>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 overflow-x-auto pb-1 scrollbar-none">
              <span className="text-[10px] font-bold text-ink-400 shrink-0">Ngành nghề nổi bật:</span>
              {Array.from(new Set(stores.map(s => s.category).filter(Boolean))).map((cat) => (
                <button
                  key={cat}
                  type="button"
                  onClick={() => setIsAllStoresDirectoryOpen(true)}
                  className="px-2.5 py-1 bg-ink-100 dark:bg-ink-800 hover:bg-ink-200 dark:hover:bg-ink-700 text-ink-700 dark:text-ink-300 font-extrabold text-[10px] rounded-xl transition shrink-0 border border-ink-200 dark:border-ink-700/80 cursor-pointer"
                >
                   {cat}
                </button>
              ))}
            ...
            {/* Helper Alert Banner */}
            <div className="p-2 rounded-xl border text-[11px] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 bg-brand-500/10 border-brand-500/20 text-brand-800 dark:text-brand-300">
              ...
              <div className="flex items-center gap-1.5 shrink-0 self-end sm:self-auto">
                <button
                  ...
                  className="px-2 py-0.5 bg-brand-600 hover:bg-brand-500 text-white font-extrabold text-[10px] rounded-md shrink-0 cursor-pointer shadow-xs"
                >
                  + Mở Gian Hàng Mới
                </button>
                <button
                  onClick={() => setIsPostingModalOpen(true)}
                    className="px-2 py-0.5 bg-brand-500 hover:bg-brand-400 text-ink-950 font-black text-[10px] rounded-md shrink-0 cursor-pointer shadow-xs"
                  >
                    + Đăng Bài Dịch Vụ
                  </button>
              </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-1.5 pt-1 border-t border-ink-100 dark:border-ink-800">
              ...
              {/* View Mode Buttons */}
              <div className="flex items-center gap-0.5 bg-ink-100 dark:bg-ink-800 p-0.5 rounded-lg text-xs">
                <button
                  onClick={() => { setViewMode('grid-2col'); localStorage.setItem('hb_resident_services_view_mode', 'grid-2col'); }}
                  className={`px-2 py-0.5 rounded-md text-[10px] font-bold transition flex items-center gap-1 cursor-pointer ${viewMode === 'grid-2col' ? 'bg-brand-600 text-white shadow-xs' : 'text-ink-600 dark:text-ink-400'}`}
                >
                ...
                <button
                  ...
                  className={`px-2 py-0.5 rounded-md text-[10px] font-bold transition flex items-center gap-1 cursor-pointer ${viewMode === 'card-1col' ? 'bg-brand-600 text-white shadow-xs' : 'text-ink-600 dark:text-ink-400'}`}
                >
                ...
                <button
                  ...
                  className={`px-2 py-0.5 rounded-md text-[10px] font-bold transition flex items-center gap-1 cursor-pointer ${viewMode === 'grid-3col' ? 'bg-brand-600 text-white shadow-xs' : 'text-ink-600 dark:text-ink-400'}`}
                >
            ...
            <div className="space-y-3 pt-2 border-t border-ink-100 dark:border-ink-800">
              <div className="flex items-center justify-between">
                <span className="text-xs font-black text-brand-600 dark:text-brand-400 uppercase tracking-wider flex items-center gap-1.5">
                  <Wrench className="w-4 h-4" />
                ...
                <div className="space-y-3">
                  {servicesPager.pageItems.map(service => {
                    ...
                    return (
                      <div 
                        key={service.id}
                        className="bg-white dark:bg-ink-900 border border-ink-200 dark:border-ink-800 rounded-2xl overflow-hidden shadow-xs hover:shadow-md transition duration-200 flex flex-col sm:flex-row items-stretch group"
                      >
                        ...
                        <div className="p-3.5 sm:p-4 flex-1 flex flex-col justify-between space-y-2">
                          <div>
                            <div className="flex items-center justify-between gap-2">
                              <span className="bg-brand-500/10 text-brand-600 dark:text-brand-400 text-[10px] font-extrabold px-2 py-0.5 rounded-md">
                                {service.subCategory}
                              </span>
                              <span className="bg-brand-500 text-ink-950 text-[10px] font-black px-1.5 py-0.5 rounded flex items-center gap-1">
                                <Star className="w-3 h-3 fill-ink-950" /> {service.rating.toFixed(1)}
                              </span>
                            </div>

                            <h3 
                              onClick={() => navigate(getServiceDetailUrl(service))}
                              className="font-black text-sm text-ink-900 dark:text-white hover:text-brand-600 cursor-pointer transition mt-1.5 leading-snug"
                            >
                              {service.title}
                            </h3>

                            <div className="flex flex-wrap items-center gap-3 text-xs text-ink-500 dark:text-ink-400 mt-1">
                          ...
                          <div className="pt-2 border-t border-ink-100 dark:border-ink-800 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                            ...
                            <div className="flex items-center gap-2 shrink-0">
                              <a
                                ...
                                className="flex items-center justify-center gap-1 px-3 py-1.5 bg-brand-600 hover:bg-brand-500 text-white rounded-xl text-xs font-bold transition"
                              >
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2.5 sm:gap-4">
                  {servicesPager.pageItems.map(service => {
                    ...
                    return (
                      <div 
                        key={service.id}
                        className="bg-white dark:bg-ink-900 border border-ink-200 dark:border-ink-800 rounded-2xl overflow-hidden shadow-xs hover:shadow-md transition duration-200 flex flex-col justify-between group"
                      >
                        <div className="relative h-28 sm:h-36 bg-ink-100 dark:bg-ink-800 overflow-hidden cursor-pointer" onClick={() => navigate(getServiceDetailUrl(service))}>
                          ...
                          <div className="absolute top-1.5 left-1.5 flex flex-wrap gap-1 z-10">
                            <span className="bg-ink-900/90 text-white text-[9px] font-extrabold px-1.5 py-0.5 rounded border border-ink-700">
                              {projectObj?.name.split(' (')[0]}
                            </span>
                            {isVerified && (
                          ...
                          <div className="absolute bottom-1.5 left-1.5 right-1.5 flex items-center justify-between">
                            <span className="bg-brand-500 text-ink-950 text-[10px] font-black px-1.5 py-0.5 rounded flex items-center gap-0.5">
                              <Star className="w-2.5 h-2.5 fill-ink-950" />
                        ...
                        <div className="p-2.5 sm:p-3 flex-1 flex flex-col justify-between space-y-2">
                          <div>
                            <span className="text-[10px] font-bold text-brand-600 dark:text-brand-400 truncate block">
                              {service.subCategory}
                            </span>
                            
                            <h3 
                              onClick={() => navigate(getServiceDetailUrl(service))}
                              className="font-black text-xs sm:text-sm text-ink-900 dark:text-white line-clamp-2 hover:text-brand-600 cursor-pointer transition leading-snug mt-0.5"
                            >
                              {service.title}
                            </h3>

                            <div className="text-[11px] font-extrabold text-ink-700 dark:text-ink-300 mt-1 truncate">
                               {service.providerName}
                            </div>
                          </div>
                          ...
                          <div className="pt-2 border-t border-ink-100 dark:border-ink-800 space-y-1.5">
                            ...
                            <div className="grid grid-cols-2 gap-1">
                              <a
                                href={`tel:${service.providerPhone}`}
                                className="flex items-center justify-center gap-1 py-1.5 bg-brand-600 hover:bg-brand-500 text-white rounded-lg text-[10px] font-extrabold"
                              >
                ...
                <div className={
                  ...
                  {servicesPager.pageItems.map(service => {
                    ...
                    return (
                      <div 
                        key={service.id}
                        className="bg-white dark:bg-ink-900 border border-ink-200 dark:border-ink-800 rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition duration-200 flex flex-col justify-between group"
                      >
                        {/* Thumbnail Header */}
                        <div className="relative h-48 bg-ink-100 dark:bg-ink-800 overflow-hidden cursor-pointer" onClick={() => navigate(getServiceDetailUrl(service))}>
                          ...
                          <div className="absolute top-3 left-3 flex flex-wrap gap-1.5 z-10">
                            <span className="bg-ink-900/90 backdrop-blur-md text-white text-[10px] font-black px-2.5 py-1 rounded-lg border border-ink-700">
                              {projectObj?.name.split(' (')[0]}
                            </span>

                            {/* Gold Badge */}
                            {isGold && (
                              <span className="bg-brand-500 text-ink-950 text-[10px] font-black px-2.5 py-1 rounded-lg flex items-center gap-1 shadow-md">
                                <Award className="w-3.5 h-3.5 fill-ink-950" />
                            ...
                            {/* Pending Badge */}
                            {isPending && (
                              <span className="bg-brand-500 text-ink-950 text-[10px] font-bold px-2 py-1 rounded-lg flex items-center gap-1 shadow-xs">
                                <Clock className="w-3 h-3 text-ink-950" />
                          ...
                          <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between">
                            <span className="bg-brand-950/90 backdrop-blur-md text-brand-300 text-[10px] font-bold px-2.5 py-1 rounded-md border border-brand-800/80">
                              {service.subCategory}
                            </span>
                            <span className="bg-brand-500 text-ink-950 text-[11px] font-black px-2 py-0.5 rounded-md flex items-center gap-1">
                              <Star className="w-3 h-3 fill-ink-950" />
                        ...
                        <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
                          <div>
                            <h3 
                              onClick={() => navigate(getServiceDetailUrl(service))}
                              className="font-black text-sm text-ink-900 dark:text-white line-clamp-2 hover:text-brand-600 dark:hover:text-brand-400 cursor-pointer transition"
                            >
                              {service.title}
                            </h3>
                            ...
                            <div className="text-xs font-bold text-ink-700 dark:text-ink-300 mt-1 flex items-center gap-1">
                              <User className="w-3.5 h-3.5 text-ink-400" />
                              <span className="text-brand-700 dark:text-brand-400 font-extrabold">{service.providerName}</span>
                              {service.subdivision && (
                                <span className="text-[11px] text-ink-400 font-normal">({service.subdivision})</span>
                              )}
                            </div>

                            <p className="text-xs text-ink-600 dark:text-ink-400 line-clamp-2 mt-2 leading-relaxed">
                              {service.description}
                            </p>
                          </div>
                          ...
                          <div className="pt-3 border-t border-ink-100 dark:border-ink-800 space-y-2">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                              <a
                                href={`tel:${service.providerPhone}`}
                                className="flex items-center justify-center gap-1 px-3 py-2 bg-brand-600 hover:bg-brand-500 text-white rounded-xl text-xs font-bold transition shadow-xs"
                              >
                                <Phone className="w-3.5 h-3.5" />
                                <span>Gọi Điện</span>
                              </a>
        ...
        <div className="lg:col-span-4 space-y-5">
          ...
          {/* PR Bulletin Card */}
          <div className="bg-white dark:bg-ink-900 rounded-3xl p-5 border border-ink-200 dark:border-ink-800 shadow-xl space-y-4 sticky top-4">
            <div className="flex items-center justify-between border-b border-ink-200 dark:border-ink-800 pb-3">
              <div>
                ...
                <h2 className="text-base font-black text-ink-900 dark:text-white mt-1">
              ...
              <div className="flex items-center justify-between font-extrabold text-brand-400 text-[11px]">
                ...
                {currentUser?.role === 'admin' && (
                  <button
                    ...
                    className="text-[9px] bg-brand-500 text-ink-950 font-black px-2 py-0.5 rounded shadow-xs cursor-pointer"
                  >
                    Vào Trang Admin
                  </button>
                )}
      ...
      {selectedServiceModal && (
        <div className="fixed inset-0 z-[60] bg-ink-950/85 backdrop-blur-md flex items-center justify-center p-3 sm:p-6 overflow-y-auto">
          <div className="bg-white dark:bg-ink-900 border border-ink-200 dark:border-ink-800 rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl my-auto relative space-y-0 animate-in zoom-in-95 duration-150">
            
            {/* Screen-Safety Fixed Floating Close Button */}
            <button
              onClick={() => setSelectedServiceModal(null)}
              className="sticky top-4 float-right mr-4 mt-4 z-50 bg-ink-900/90 hover:bg-rose-600 text-white p-2.5 rounded-full shadow-2xl transition duration-150 border border-ink-700 cursor-pointer flex items-center gap-1.5"
              title="Đóng cửa sổ"
            >
              <X className="w-5 h-5" />
            ...
            {/* Site Hero Banner */}
            <div className="bg-gradient-to-r from-ink-900 via-indigo-950 to-ink-900 text-white p-6 sm:p-8 rounded-t-3xl border-b border-ink-800 relative overflow-hidden">
              <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#10b981_1px,transparent_1px)] [background-size:16px_16px]"></div>
              
              <div className="relative z-10 space-y-3 max-w-2xl">
                <div className="flex flex-wrap items-center gap-2">
                  <span className="text-xs font-black uppercase tracking-wider bg-brand-500/20 text-brand-300 border border-brand-500/40 px-3 py-1 rounded-full">
                  ...
                  <span className="text-xs font-extrabold text-brand-400 bg-brand-500/20 border border-brand-500/30 px-2.5 py-1 rounded-full flex items-center gap-1">
                ...
                <div className="flex flex-wrap items-center gap-4 text-xs text-ink-300 pt-1">
            ...
            <div className="p-6 sm:p-8 space-y-6">
              ...
              <div className="space-y-2">
                <h3 className="text-xs font-black uppercase tracking-wider text-ink-400 flex items-center gap-1.5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 rounded-2xl overflow-hidden">
                  {selectedServiceModal.images.map((img, idx) => (
                    <img loading="lazy"
                      ...
                      src={img}
                      alt={`mô tả ${idx}`}
                      className="w-full h-48 object-cover rounded-2xl border border-ink-200 dark:border-ink-800 hover:scale-105 transition duration-300 shadow-sm"
                    />
                  ))}
                </div>
              </div>
              ...
              <div className="bg-brand-950/20 border border-brand-500/40 p-5 rounded-2xl space-y-3">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-brand-800/50 pb-3">
                  <span className="text-sm font-black text-brand-400 flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-ink-300">
                  ...
                  {selectedServiceModal.businessLicenseNo && (
                    <div>• <b>Số ĐKKD / Đăng ký Doanh nghiệp:</b> <span className="font-mono text-brand-300 font-bold">{selectedServiceModal.businessLicenseNo}</span></div>
                  )}
                ...
                {selectedServiceModal.submittedDocs && selectedServiceModal.submittedDocs.length > 0 && (
                  <div className="pt-3 border-t border-brand-800/60 space-y-2">
                    <span className="text-xs font-bold text-brand-300">Các chứng chỉ & giấy phép đã thẩm định:</span>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {selectedServiceModal.submittedDocs.map(doc => (
                        <div key={doc.id} className="flex items-center justify-between bg-ink-900/80 p-2.5 rounded-xl border border-ink-800 text-xs text-ink-300">
                          <div className="flex items-center gap-2">
                            <FileCheck className="w-4 h-4 text-brand-400 shrink-0" />
                            <span className="font-medium">{doc.docType}</span>
                          </div>
                          <span className="text-[10px] font-extrabold text-brand-400 uppercase bg-brand-500/10 px-2 py-0.5 rounded">{doc.status}</span>
                        </div>
                      ))}
                    </div>
                  </div>
              ...
              <div className="space-y-3">
                ...
                <p className="text-xs sm:text-sm text-ink-700 dark:text-ink-300 leading-relaxed whitespace-pre-line bg-ink-50/80 dark:bg-ink-800/40 p-4 rounded-2xl border border-ink-200 dark:border-ink-800 font-medium">
                  {selectedServiceModal.description}
                </p>
              </div>

              {/* Interactive Booking/Quote Form */}
              <div className="bg-ink-50 dark:bg-ink-800/60 p-5 rounded-2xl border border-ink-200 dark:border-ink-700 space-y-4">
                <div className="flex items-center justify-between">
                  <h4 className="text-sm font-black text-ink-900 dark:text-white flex items-center gap-2">
                    <Clock className="w-4 h-4 text-brand-500" />
                    <span>YÊU CẦU KHẢO SÁT & BÁO GIÁ TẬN NƠI</span>
                  </h4>
                  <span className="text-[10px] font-bold text-brand-600 dark:text-brand-400">Miễn phí 100%</span>
                </div>
                ...
                <form onSubmit={async (e) => {
                  ...
                  <div>
                    <label className="block text-[11px] font-bold text-ink-500 dark:text-ink-400 mb-1">Tên cư dân:</label>
                    <input 
                      type="text" 
                      required 
                      defaultValue={currentUser?.displayName || ''} 
                      placeholder="Nguyễn Văn A" 
                      className="w-full px-3 py-2 bg-white dark:bg-ink-900 border border-ink-200 dark:border-ink-700 rounded-xl text-xs font-bold text-ink-900 dark:text-white"
                    />
                  </div>
                  <div>
                    <label className="block text-[11px] font-bold text-ink-500 dark:text-ink-400 mb-1">Số phòng / Tòa nhà:</label>
                    <input 
                      type="text" 
                      required 
                  ...
                  <div>
                    <label className="block text-[11px] font-bold text-ink-500 dark:text-ink-400 mb-1">Số điện thoại liên hệ:</label>
                    <input 
                      type="tel" 
                      required 
                  ...
                  <div>
                    <label className="block text-[11px] font-bold text-ink-500 dark:text-ink-400 mb-1">Thời gian mong muốn:</label>
                    <input 
                      type="text" 
                  ...
                  <div className="sm:col-span-2">
                    <button
                      type="submit"
                      className="w-full py-2.5 bg-brand-600 hover:bg-brand-500 text-white rounded-xl font-black text-xs transition shadow-md cursor-pointer"
                    >
            ...
            <div className="p-5 border-t border-ink-200 dark:border-ink-800 bg-ink-50 dark:bg-ink-800/80 rounded-b-3xl flex flex-col sm:flex-row items-center justify-between gap-3 sticky bottom-0 z-30">
              <div className="text-xs text-ink-500 dark:text-ink-400 font-medium hidden sm:block">
                Hotline hỗ trợ: <strong className="text-brand-600 dark:text-brand-400">{selectedServiceModal.providerPhone}</strong>
              </div>

              <div className="flex items-center gap-3 w-full sm:w-auto">
                <a
                  href={`tel:${selectedServiceModal.providerPhone}`}
                  className="flex-1 sm:flex-none px-5 py-3 bg-brand-600 hover:bg-brand-500 text-white rounded-xl text-xs font-black text-center transition flex items-center justify-center gap-2 shadow-md cursor-pointer"
                >
      ...
      {isPostingModalOpen && (
        <div className="fixed inset-0 z-50 bg-ink-900/80 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white dark:bg-ink-900 border border-ink-200 dark:border-ink-800 rounded-3xl max-w-2xl w-full overflow-hidden shadow-2xl my-8">
            {/* Modal Title */}
            <div className="p-5 border-b border-ink-100 dark:border-ink-800 flex items-center justify-between bg-ink-50 dark:bg-ink-800/50">
              <div className="flex items-center gap-2">
                <PlusCircle className="w-5 h-5 text-brand-600" />
                <h2 className="text-base font-black text-ink-900 dark:text-white uppercase">
                  ĐĂNG DỊCH VỤ / ĐỊNH DANH NÚT XANH KYC
                </h2>
              </div>
              <button
                onClick={() => setIsPostingModalOpen(false)}
                className="text-ink-400 hover:text-ink-600 dark:hover:text-ink-200 p-1.5 rounded-xl hover:bg-ink-200 dark:hover:bg-ink-800 transition"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <form onSubmit={handlePostServiceSubmit} className="p-5 space-y-4 max-h-[75vh] overflow-y-auto">
              ...
              <div className="p-3.5 bg-gradient-to-r from-brand-500/15 via-brand-500/10 to-transparent border border-brand-500/40 rounded-2xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 shadow-inner">
                <div className="flex items-center gap-2.5">
                  <div className="w-8 h-8 rounded-xl bg-brand-500/20 flex items-center justify-center text-brand-500 shrink-0">
                    <Sparkles className="w-4 h-4" />
                  </div>
                  <div>
                    <span className="font-extrabold text-xs text-brand-700 dark:text-brand-300 block">
                ...
                <button
                  ...
                  className="px-3.5 py-1.5 bg-gradient-to-r from-brand-500 to-brand-600 hover:from-brand-400 text-ink-950 font-black text-xs rounded-xl shadow-xs shrink-0 flex items-center gap-1.5 transition cursor-pointer self-end sm:self-center"
                >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2.5 bg-ink-50 dark:bg-ink-800 border border-ink-200 dark:border-ink-700 rounded-xl text-xs font-bold"
                  >
              ...
              {activeIndustryKycRule && (
                <div className="bg-brand-950/20 border border-brand-500/40 p-3.5 rounded-2xl text-xs space-y-1.5">
                  <div className="flex items-center gap-2 font-black text-brand-400">
                  ...
                  <div className="pt-1">
                    <span className="font-bold text-brand-300">Giấy phép/chứng chỉ bắt buộc:</span>
                    <ul className="mt-1 space-y-1 text-ink-200">
              ...
              <div className="p-3 bg-ink-50 dark:bg-ink-800/80 rounded-2xl border border-ink-200 dark:border-ink-700 space-y-3">
                <div className="flex items-center justify-between">
                ...
                {postForm.applyKycNow && (
                  <div className="space-y-2 pt-1 text-xs">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      <div>
                        <label className="font-bold text-ink-600 dark:text-ink-400">Số Giấy phép ĐKKD / Mã số thuế (Nếu có):</label>
                        <input
                          type="text"
                          ...
                          className="w-full mt-1 p-2 bg-white dark:bg-ink-900 border border-ink-200 dark:border-ink-700 rounded-xl font-mono text-xs"
                        />
                      </div>
                      <div>
                        <label className="font-bold text-ink-600 dark:text-ink-400">Tên Tệp Scan / Bằng cấp tải lên:</label>
                        <input
                          type="text"
                          ...
                          className="w-full mt-1 p-2 bg-white dark:bg-ink-900 border border-ink-200 dark:border-ink-700 rounded-xl text-xs"
                        />
                      </div>
                    </div>
                  </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <label className="px-3 py-1 bg-brand-600 hover:bg-brand-500 text-white font-bold text-[11px] rounded-lg cursor-pointer flex items-center gap-1 shadow transition">
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 bg-ink-50 dark:bg-ink-800 border border-ink-200 dark:border-ink-700 rounded-xl text-xs font-mono"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 bg-ink-50 dark:bg-ink-800 border border-ink-200 dark:border-ink-700 rounded-xl text-xs font-medium"
                />
              </div>

              {/* MANDATORY LEGAL COMMITMENT CHECKBOX */}
              <div className="bg-brand-50 dark:bg-brand-950/50 p-3.5 rounded-2xl border border-brand-200 dark:border-brand-800 space-y-2">
                <label className="flex items-start gap-2.5 cursor-pointer">
                  <input
                    ...
                    className="w-4 h-4 text-brand-600 rounded border-ink-300 focus:ring-brand-500 mt-0.5 shrink-0"
                  />
                  <span className="text-xs font-extrabold text-brand-950 dark:text-brand-200 leading-snug">
                    Tôi xác nhận thông tin đăng bài là trung thực, đồng ý tuân thủ{' '}
                    <button
                      type="button"
                      onClick={() => setIsTripartiteModalOpen(true)}
                      className="text-brand-700 dark:text-brand-400 font-black underline hover:text-brand-600 inline-flex items-center gap-0.5 cursor-pointer"
                    >
                       Thỏa thuận Ba Bên
                    </button>
                ...
                <div className="text-[10px] text-brand-700 dark:text-brand-300/80 pl-6">
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  className="w-full py-3 bg-brand-600 hover:bg-brand-500 text-white font-black text-xs uppercase tracking-wider rounded-xl shadow-lg transition"
                >
      ...
      {isPRModalOpen && (
        <div className="fixed inset-0 z-50 bg-ink-950/85 backdrop-blur-md flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
          <button
          ...
          <div className="bg-white dark:bg-ink-900 border border-ink-200 dark:border-ink-800 rounded-3xl max-w-lg w-full p-6 space-y-4 shadow-2xl relative my-auto max-h-[88vh] overflow-y-auto">
            <button
              onClick={() => setIsPRModalOpen(false)}
              className="absolute top-4 right-4 p-1.5 bg-ink-100 dark:bg-ink-800 text-ink-500 hover:text-ink-900 dark:hover:text-white rounded-full transition"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            >
              ...
              <div className="p-3 bg-purple-500/10 dark:bg-purple-950/40 border border-purple-500/30 rounded-2xl space-y-2">
                <div className="flex items-center justify-between">
                  <label className="block font-black text-purple-700 dark:text-purple-300 text-xs">
                     TAB CHỌN SHOP CẦN BÀI PR (Click tab để chọn):
                  </label>
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-xl text-xs font-black transition flex items-center gap-1 shrink-0 border cursor-pointer ${
                          isSelected
                            ...
                            : 'bg-white dark:bg-ink-800 text-ink-700 dark:text-ink-300 border-ink-200 dark:border-ink-700 hover:border-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/30'
                        }`}
                      >
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label className="block font-bold text-ink-700 dark:text-ink-300 mb-1">Ngành Hàng</label>
                  <select
                ...
                <div>
                  <label className="block font-bold text-ink-700 dark:text-ink-300 mb-1">Đánh Giá Sao</label>
                  <select
                    value={newPRForm.rating}
                    onChange={(e) => setNewPRForm({ ...newPRForm, rating: Number(e.target.value) })}
                    className="w-full p-2.5 bg-ink-50 dark:bg-ink-800 border border-ink-200 dark:border-ink-700 rounded-xl font-bold text-brand-500"
                  >
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label className="block font-bold text-ink-700 dark:text-ink-300 mb-1">Tên Người Đăng</label>
                  <input
                    type="text"
                    required
                    ...
                    placeholder="Nguyễn Văn A"
                    className="w-full p-2.5 bg-ink-50 dark:bg-ink-800 border border-ink-200 dark:border-ink-700 rounded-xl font-medium"
                  />
                </div>

                <div>
                  <label className="block font-bold text-ink-700 dark:text-ink-300 mb-1">Căn Hộ / Tòa Nhà</label>
                  <input
                    type="text"
                    required
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-2.5 bg-ink-50 dark:bg-ink-800 border border-ink-200 dark:border-ink-700 rounded-xl font-mono text-xs text-rose-500 font-bold"
                />
              </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="w-full p-2 bg-ink-50 dark:bg-ink-800 border border-ink-200 dark:border-ink-700 rounded-xl font-mono text-xs"
                  />
                  {newPRForm.imageUrl && (
      ...
      {selectedPRArticle && (
        <div className="fixed inset-0 z-50 bg-ink-950/85 backdrop-blur-md flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
          ...
          <div className="bg-white dark:bg-ink-900 border border-ink-200 dark:border-ink-800 rounded-3xl max-w-lg w-full p-6 space-y-4 shadow-2xl relative my-auto max-h-[88vh] overflow-y-auto">
            ...
            <h2 className="text-lg font-black text-ink-900 dark:text-white leading-snug">
              {selectedPRArticle.title}
            </h2>

            <div className="flex items-center justify-between text-xs font-bold text-ink-600 dark:text-ink-400 border-b border-ink-200 dark:border-ink-800 pb-3">
              <span> {selectedPRArticle.partnerName}</span>
              <span className="text-brand-500 flex items-center gap-1 font-black">
            ...
            {getYouTubeEmbedUrl(selectedPRArticle.youtubeUrl) ? (
              <div className="rounded-2xl overflow-hidden border border-ink-200 dark:border-ink-700 aspect-video w-full bg-black shadow-lg">
                <iframe
              ...
              selectedPRArticle.images?.[0] && (
                <img loading="lazy"
                  ...
                  className="w-full h-48 object-cover rounded-2xl border border-ink-200 dark:border-ink-800"
                />
              )
            )}

            <p className="text-xs text-ink-700 dark:text-ink-300 leading-relaxed font-medium bg-ink-50 dark:bg-ink-800/60 p-4 rounded-2xl border border-ink-200/60 dark:border-ink-700/60 whitespace-pre-line">
            ...
            <div className="p-3 bg-purple-500/10 border border-purple-500/30 rounded-2xl flex items-center justify-between text-xs">
              <div>
                ...
                <span className="text-ink-600 dark:text-ink-400">{selectedPRArticle.authorName} ({selectedPRArticle.authorRoom})</span>
              </div>
              <span className="text-[10px] font-bold text-ink-400">{selectedPRArticle.createdAt}</span>
            </div>
            ...
            {selectedPRArticle.phoneContact && (
              <div className="grid grid-cols-2 gap-2 pt-2">
                <a
                  ...
                  className="py-2.5 bg-brand-600 hover:bg-brand-500 text-white font-extrabold text-xs rounded-xl text-center flex items-center justify-center gap-1.5 shadow-md"
                >
                  <Phone className="w-4 h-4" />
      ...
      {isTransportModalOpen && (
        <div className="fixed inset-0 z-50 bg-ink-950/80 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white dark:bg-ink-900 border border-ink-200 dark:border-ink-800 rounded-3xl max-w-xl w-full p-6 space-y-5 shadow-2xl relative my-auto max-h-[90vh] overflow-y-auto">
            <button
              onClick={() => {
                setIsTransportModalOpen(false);
                setTransportSubmitResult(null);
              }}
              className="absolute top-4 right-4 p-2 bg-ink-100 dark:bg-ink-800 text-ink-500 hover:text-ink-900 dark:hover:text-white rounded-full transition cursor-pointer"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            <div className="space-y-1 pr-8">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-brand-500/10 text-brand-600 dark:text-brand-400 font-black text-xs rounded-full border border-brand-500/30">
                <Car className="w-4 h-4" />
                <span>HỆ THỐNG VẬN TẢI NỘI KHU & NGOẠI KHU 24/7</span>
              </div>
              <h2 className="text-lg sm:text-xl font-black text-ink-900 dark:text-white">
            ...
            {transportSubmitResult ? (
              <div className="bg-brand-500/10 border-2 border-brand-500/40 rounded-2xl p-5 space-y-3 text-center">
                <CheckCircle2 className="w-12 h-12 text-brand-500 mx-auto animate-bounce" />
                <h3 className="text-base font-black text-brand-800 dark:text-brand-300">
                  ĐÃ BẮT ĐẦU ĐỔ YÊU CẦU TỚI BỘ PHẬN ĐIỀU XE!
                </h3>
                <p className="text-xs text-ink-700 dark:text-ink-300 font-medium leading-relaxed">
                  {transportSubmitResult}
                </p>
                <div className="pt-2 flex flex-col sm:flex-row gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2.5 bg-ink-200 dark:bg-ink-800 text-ink-800 dark:text-ink-200 rounded-xl text-xs font-bold cursor-pointer"
                  >
                    Hoàn Tất
                  </button>
                </div>
              ...
              <form onSubmit={handleTransportSubmit} className="space-y-4 text-xs">
                ...
                <div className="grid grid-cols-2 gap-2 p-1 bg-ink-100 dark:bg-ink-800 rounded-2xl">
                  <button
                    ...
                    className={`py-2.5 px-3 rounded-xl font-black text-xs transition flex items-center justify-center gap-1.5 cursor-pointer ${
                      transportTab === 'noi_khu'
                        ? 'bg-brand-500 text-ink-950 shadow-md ring-2 ring-brand-400'
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      setTransportServiceType(' Taxi Sân Bay Nội Bài (Trọn gói)');
                    }}
                    className={`py-2.5 px-3 rounded-xl font-black text-xs transition flex items-center justify-center gap-1.5 cursor-pointer ${
                ...
                <div className="space-y-1">
                  ...
                  <select
                    ...
                    className="w-full p-2.5 bg-ink-50 dark:bg-ink-800 border border-ink-200 dark:border-ink-700 rounded-xl font-bold text-ink-900 dark:text-white"
                  >
                    {transportTab === 'noi_khu' ? (
                      <>
                      ...
                      <>
                        <option value=" Taxi Sân Bay Nội Bài (Trọn gói 200k-350k)"> Taxi Sân Bay Nội Bài (Trọn gói 200k-350k)</option>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    <label className="block font-bold text-ink-700 dark:text-ink-300 mb-1">Điểm đón (*):</label>
                    <input
                      type="text"
                      required
                  ...
                  <div>
                    <label className="block font-bold text-ink-700 dark:text-ink-300 mb-1">Điểm đến (*):</label>
                    <input
                      type="text"
                      required
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    <label className="block font-bold text-ink-700 dark:text-ink-300 mb-1">Tên cư dân / Khách hàng (*):</label>
                    <input
                      type="text"
                      required
                      value={transportName}
                  ...
                  <div>
                    <label className="block font-bold text-ink-700 dark:text-ink-300 mb-1">Số điện thoại / Zalo nhận báo giá (*):</label>
                    <input
                      type="tel"
                      required
                ...
                <div>
                  <label className="block font-bold text-ink-700 dark:text-ink-300 mb-1">Thời gian đón dự kiến:</label>
                  <input
                    type="text"
                    value={transportTime}
                ...
                <div>
                  <label className="block font-bold text-ink-700 dark:text-ink-300 mb-1">Ghi chú thêm (Hành lý, yêu cầu xe):</label>
                  <textarea
                    rows={2}
                    value={transportNote}
                    onChange={(e) => setTransportNote(e.target.value)}
                    placeholder="Cần xe 7 chỗ VF8, mang theo 2 vali lớn..."
                    className="w-full p-2.5 bg-ink-50 dark:bg-ink-800 border border-ink-200 dark:border-ink-700 rounded-xl text-ink-900 dark:text-white font-medium"
                  />
                </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <label className="px-2.5 py-1 bg-brand-500 hover:bg-brand-400 text-ink-950 font-bold text-[11px] rounded-lg cursor-pointer flex items-center gap-1 shadow transition">
                      <Upload className="w-3 h-3" />
                      <span> Tải Ảnh Từ Máy</span>
                      <input
                        type="file"
                  ...
                  {transportImages.length > 0 && (
                    <div className="flex gap-2 overflow-x-auto py-1">
                      {transportImages.map((img, idx) => (
                        <div key={idx} className="relative w-14 h-14 rounded-lg overflow-hidden border border-brand-500/40 shrink-0">
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="w-full py-3 bg-brand-500 hover:bg-brand-400 text-ink-950 font-black rounded-xl text-sm transition shadow-lg flex items-center justify-center gap-2 cursor-pointer"
                  >
              ...
              <form onSubmit={handleConstructionSubmit} className="space-y-4 text-xs">
                ...
                <div className="space-y-1">
                  ...
                  >
                    ...
                    <option value=" Thi Công Xây Lắp & Cải Tạo Xây Dựng Biệt Thự / Shophouse"> Thi Công Xây Lắp & Cải Tạo Xây Dựng Biệt Thự / Shophouse (Đổ sàn, đập phá, mở rộng)</option>
                    <option value=" Thi Công Nội Thất Trọn Gói Gỗ An Cường"> Thi Công Nội Thất Trọn Gói Gỗ An Cường (Bếp, Khách, Phòng Ngủ)</option>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    <label className="block font-bold text-ink-700 dark:text-ink-300 mb-1">Khu đô thị Vinhomes (*):</label>
                    <select
                  ...
                  <div>
                    <label className="block font-bold text-ink-700 dark:text-ink-300 mb-1">Phân khu / Mã căn / Số phòng (*):</label>
                    <input
                      type="text"
                      required
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    <label className="block font-bold text-ink-700 dark:text-ink-300 mb-1">Tên chủ nhà / Cư dân (*):</label>
                    <input
                      type="text"
                      required
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    <label className="block font-bold text-ink-700 dark:text-ink-300 mb-1">Dự toán ngân sách dự kiến:</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block font-bold text-ink-700 dark:text-ink-300 mb-1">Thời gian muốn khảo sát:</label>
                    <input
                      type="text"
                ...
                <div>
                  <label className="block font-bold text-ink-700 dark:text-ink-300 mb-1">Ghi chú đặc biệt (Bản vẽ, thông số hố thang, yêu cầu vật liệu):</label>
                  <textarea
                    rows={2}
      ...
      {showLegalDisclaimer && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white dark:bg-ink-900 border border-ink-200 dark:border-ink-800 rounded-3xl max-w-2xl w-full p-6 sm:p-8 shadow-2xl relative overflow-hidden">
            <button
              onClick={() => setShowLegalDisclaimer(false)}
              className="absolute top-4 right-4 p-2 text-ink-400 hover:text-ink-600 dark:hover:text-white rounded-full bg-ink-100 dark:bg-ink-800 cursor-pointer"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            <div className="flex items-center gap-3 mb-4 text-brand-600 dark:text-brand-400">
              ...
              <div>
                ...
                <p className="text-xs text-ink-500 dark:text-ink-400 font-semibold">
                  Nền Tảng Cầu Nối chocudan24h.com
                </p>
              </div>
            </div>

            <div className="space-y-4 text-xs sm:text-sm text-ink-700 dark:text-ink-300 leading-relaxed max-h-[60vh] overflow-y-auto pr-2">
              <div className="bg-brand-50 dark:bg-brand-950/40 border border-brand-200 dark:border-brand-800/60 rounded-2xl p-4">
                <h4 className="font-extrabold text-brand-900 dark:text-brand-200 text-sm mb-1">
            ...
            <div className="mt-6 pt-4 border-t border-ink-100 dark:border-ink-800">
              <button
                onClick={() => setShowLegalDisclaimer(false)}
                className="w-full py-3 bg-ink-900 hover:bg-ink-800 dark:bg-brand-600 dark:hover:bg-brand-500 text-white font-extrabold rounded-2xl text-sm transition shadow-md cursor-pointer"
              >
