...
export const TripartiteAgreementModal: React.FC<TripartiteAgreementModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-ink-950/80 backdrop-blur-md p-4 overflow-y-auto animate-fadeIn">
      <div className="bg-white dark:bg-ink-900 border border-ink-200 dark:border-ink-800 rounded-3xl max-w-4xl w-full shadow-2xl overflow-hidden my-8 flex flex-col max-h-[90vh]">
        
        {/* Header */}
        <div className="bg-ink-950 text-white p-5 sm:p-6 relative border-b border-ink-800 flex-shrink-0">
          <button
            onClick={onClose}
            className="absolute top-4 right-4 text-ink-400 hover:text-white bg-ink-800/80 hover:bg-ink-800 p-2 rounded-full transition"
            title="Đóng"
          >
            <X className="w-5 h-5" />
          </button>
          ...
          <div className="flex items-center space-x-3 mb-2">
            <span className="px-3 py-1 bg-brand-500/20 text-brand-400 border border-brand-500/30 rounded-full text-xs font-bold uppercase tracking-wider flex items-center gap-1.5">
              <Scale className="w-3.5 h-3.5" /> Thỏa thuận Pháp lý Ba Bên
            </span>
            <span className="px-2.5 py-0.5 bg-brand-500/20 text-brand-400 border border-brand-500/30 rounded-full text-[11px] font-semibold">
              chocudan24h.com
            </span>
          </div>
          ...
          <p className="text-xs text-ink-400 mt-1">
            Mô hình kết nối minh bạch giữa <strong className="text-brand-400">Cư dân/Khách hàng (Bên A)</strong> — <strong className="text-brand-400">Đối tác/Nhà cung cấp (Bên B)</strong> — <strong className="text-brand-400">Nền tảng chocudan24h.com (Bên C)</strong>.
          </p>

          {/* Sub Navigation */}
          <div className="flex items-center gap-2 mt-4 pt-3 border-t border-ink-800 text-xs">
            <button
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1 text-ink-700 dark:text-ink-300 text-sm leading-relaxed">
          
          {activeTab === 'summary' && (
            <div className="space-y-6">
              
              {/* Highlight Core Rule Banner */}
              <div className="bg-brand-500/10 border-2 border-brand-500/40 rounded-2xl p-4 sm:p-5 flex items-start space-x-4">
                <div className="p-3 bg-brand-500 rounded-xl text-ink-950 flex-shrink-0 mt-0.5">
                  <Handshake className="w-6 h-6" />
                </div>
                <div>
                  <h4 className="font-black text-brand-700 dark:text-brand-400 text-base uppercase tracking-wide">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                {/* Party A */}
                <div className="bg-ink-50 dark:bg-ink-800/60 border border-ink-200 dark:border-ink-700 rounded-2xl p-4 flex flex-col justify-between">
                  <div>
                    ...
                    <ul className="text-xs space-y-2 text-ink-600 dark:text-ink-300">
                      <li className="flex items-start gap-1.5">
                        <Check className="w-3.5 h-3.5 text-brand-500 mt-0.5 flex-shrink-0" />
                  ...
                  <div className="mt-3 pt-2 border-t border-ink-200 dark:border-ink-700 text-[11px] font-semibold text-ink-500">
                ...
                <div className="bg-ink-50 dark:bg-ink-800/60 border border-ink-200 dark:border-ink-700 rounded-2xl p-4 flex flex-col justify-between">
                  <div>
                    <div className="flex items-center space-x-2 text-brand-600 dark:text-brand-400 font-black text-xs uppercase tracking-wider mb-2">
              ...
              <div className="bg-ink-100 dark:bg-ink-800 border border-ink-200 dark:border-ink-700 rounded-2xl p-4 flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <div className="p-2.5 bg-indigo-500/10 text-indigo-500 rounded-xl">
                    <FileSpreadsheet className="w-5 h-5" />
                  </div>
                  <div>
                    <div className="font-bold text-xs text-ink-900 dark:text-white">
          ...
          {activeTab === 'full' && (
            <div className="space-y-4 text-xs text-ink-600 dark:text-ink-300 font-mono bg-ink-50 dark:bg-ink-950 p-5 rounded-2xl border border-ink-200 dark:border-ink-800 leading-relaxed max-h-[400px] overflow-y-auto">
              <h3 className="font-black text-sm text-ink-900 dark:text-white uppercase font-sans">
                CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM<br />
                Độc lập - Tự do - Hạnh phúc
              </h3>
              <p className="text-center font-bold text-ink-800 dark:text-ink-200 py-2 font-sans">
                QUY CHẾ HOẠT ĐỘNG & THỎA THUẬN SỬ DỤNG DỊCH VỤ NỀN TẢNG BẤT ĐỘNG SẢN & DỊCH VỤ CƯ DÂN
              </p>

              <div className="space-y-3 font-sans">
                <div>
                  <strong className="text-ink-900 dark:text-white">CĂN CỨ PHÁP LÝ:</strong>
                ...
                <div>
                  <strong className="text-ink-900 dark:text-white">ĐIỀU 1: ĐỊNH NGHĨA CÁC BÊN THAM GIA</strong>
                ...
                <div>
                  <strong className="text-ink-900 dark:text-white">ĐIỀU 2: NGUYÊN TẮC GIAO DỊCH VÀ PHẠM VI TỰ DO THỎA THUẬN</strong>
                ...
                <div>
                  <strong className="text-ink-900 dark:text-white">ĐIỀU 3: MIỄN TRỪ TRÁCH NHIỆM PHÁP LÝ CỦA NỀN TẢNG (BÊN C)</strong>
                ...
                <div>
                  <strong className="text-ink-900 dark:text-white">ĐIỀU 4: VAI TRÒ GIÁM SÁT VÀ XỬ LÝ SỰ CỐ CỦA BÊN C</strong>
                ...
                <div>
                  <strong className="text-ink-900 dark:text-white">ĐIỀU 5: HIỆU LỰC RÀNG BUỘC KHI ĐĂNG KÝ / ĐẶT DỊCH VỤ</strong>
          ...
          {activeTab === 'faq' && (
            <div className="space-y-4">
              <div className="bg-ink-50 dark:bg-ink-800/80 p-4 rounded-xl border border-ink-200 dark:border-ink-700">
                <h4 className="font-bold text-ink-900 dark:text-white text-xs uppercase flex items-center gap-1.5 text-brand-500">
        ...
        {/* Footer Actions */}
        <div className="p-4 sm:p-5 bg-ink-100 dark:bg-ink-950 border-t border-ink-200 dark:border-ink-800 flex-shrink-0 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex items-center space-x-2 text-xs text-ink-500 dark:text-ink-400">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            <button
              onClick={onClose}
              className="px-4 py-2.5 bg-ink-200 dark:bg-ink-800 hover:bg-ink-300 dark:hover:bg-ink-700 text-ink-700 dark:text-ink-300 rounded-xl text-xs font-bold transition w-1/2 sm:w-auto"
            >
              Đóng & Xem Sau
            </button>
            <button
              onClick={handleConfirmAccept}
              className="px-5 py-2.5 bg-brand-500 hover:bg-brand-600 text-ink-950 font-black rounded-xl text-xs uppercase tracking-wider transition shadow-lg flex items-center justify-center gap-1.5 w-1/2 sm:w-auto"
            >
