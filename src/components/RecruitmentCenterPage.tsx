...
export const RecruitmentCenterPage: React.FC<RecruitmentCenterPageProps> = ({
  ...
  // Phân trang tin tuyển dụng: 20 / 100 / 200
  ...
  return (
    <div className="min-h-screen bg-ink-50 dark:bg-ink-950 text-ink-900 dark:text-ink-100 pb-24">
      
      {/* Top Hero Banner */}
      <div className="bg-[#16284e] text-white border-b border-ink-700/60 shadow-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <div className="inline-flex items-center gap-1.5 bg-brand-500/20 text-brand-300 border border-brand-400/30 px-3 py-1 rounded-full text-xs font-bold mb-2">
              ...
              <h1 className="text-xl sm:text-3xl font-black tracking-tight text-white flex items-center gap-2">
                <Briefcase className="w-6 h-6 sm:w-8 sm:h-8 text-brand-400 shrink-0" />
                <span>Tuyển Dụng & Tìm Việc Làm Nội Khu</span>
              </h1>
              <p className="text-ink-300 text-xs sm:text-sm mt-1 max-w-2xl">
            ...
            <div className="flex items-center gap-2 sm:gap-3 shrink-0">
              ...
              <button
                ...
                className="px-3.5 py-2 sm:px-5 sm:py-2.5 bg-brand-500 hover:bg-brand-400 active:bg-brand-600 text-ink-950 rounded-xl text-xs sm:text-sm font-black flex items-center gap-1.5 transition shadow-lg"
              >
          ...
          {/* Quick Metrics Bar */}
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4 mt-6 pt-4 border-t border-brand-700/40 text-xs">
            <div className="flex items-center gap-2 bg-ink-900/40 p-2.5 rounded-xl border border-white/5">
              <div className="w-8 h-8 rounded-lg bg-brand-500/20 text-brand-300 flex items-center justify-center font-black">
                {totalActiveJobs}
              </div>
              <div>
                <div className="font-bold text-white">Tin Tuyển Dụng</div>
                <div className="text-[10px] text-ink-400">Đang tuyển dụng</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 bg-ink-900/40 p-2.5 rounded-xl border border-white/5">
              ...
              <div>
                ...
                <div className="text-[10px] text-ink-400">Sẵn sàng nhận việc</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 bg-ink-900/40 p-2.5 rounded-xl border border-white/5">
              ...
              <div>
                ...
                <div className="text-[10px] text-ink-400">Xác thực căn hộ & tòa nhà</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 bg-ink-900/40 p-2.5 rounded-xl border border-white/5">
              ...
              <div>
                ...
                <div className="text-[10px] text-ink-400">Xem Full SĐT & Zalo</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="sticky top-[56px] z-30 bg-white/95 dark:bg-ink-900/95 backdrop-blur-md border-b border-ink-200 dark:border-ink-800 shadow-xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between overflow-x-auto no-scrollbar py-2 gap-2">
            ...
            <button
              ...
              className="hidden sm:flex px-3 py-1.5 bg-brand-500 hover:bg-brand-600 text-ink-950 rounded-lg text-xs font-black items-center gap-1 shrink-0"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        ...
        {(activeTab === 'jobs' || activeTab === 'candidates') && (
          <div className="bg-white dark:bg-ink-900 p-3 sm:p-4 rounded-2xl border border-ink-200 dark:border-ink-800 shadow-xs mb-6 space-y-3">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-2 sm:gap-3">
              ...
              <div className="md:col-span-5 relative">
                ...
                <input
                  ...
                  className="w-full pl-9.5 pr-4 py-2.5 bg-ink-50 dark:bg-ink-800 border border-ink-200 dark:border-ink-700 rounded-xl text-xs sm:text-sm font-medium focus:ring-2 focus:ring-brand-500 outline-hidden"
                />
                {searchQuery && (
              ...
              <div className="md:col-span-4 relative">
                <MapPin className="w-4 h-4 text-brand-600 dark:text-brand-400 absolute left-3.5 top-1/2 -translate-y-1/2" />
                <select
                  value={selectedProject}
                  onChange={(e) => setSelectedProject(e.target.value as any)}
                  aria-label="Chọn khu đô thị hoặc dự án tuyển dụng"
                  className="w-full pl-9.5 pr-8 py-2.5 bg-ink-50 dark:bg-ink-800 border border-ink-200 dark:border-ink-700 rounded-xl text-xs sm:text-sm font-semibold focus:ring-2 focus:ring-brand-500 outline-hidden appearance-none cursor-pointer"
                >
              ...
              <div className="md:col-span-3">
                <select
                  ...
                  className="w-full px-3 py-2.5 bg-ink-50 dark:bg-ink-800 border border-ink-200 dark:border-ink-700 rounded-xl text-xs sm:text-sm font-semibold focus:ring-2 focus:ring-brand-500 outline-hidden cursor-pointer"
                >
            ...
            <div className="pt-2 border-t border-ink-100 dark:border-ink-800">
              <div className="text-[11px] font-black uppercase text-ink-400 tracking-wider mb-2 flex items-center gap-1">
                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-xl text-xs font-bold whitespace-nowrap transition border flex items-center gap-1.5 ${
                        isSelected
                          ...
                          : 'bg-ink-50 dark:bg-ink-800 text-ink-700 dark:text-ink-300 border-ink-200 dark:border-ink-700 hover:border-brand-400'
                      }`}
                    >
                      <span>{ind.name}</span>
                    </button>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-base sm:text-lg font-black text-ink-900 dark:text-white flex items-center gap-2">
                ...
                <span className="text-xs font-bold px-2 py-0.5 rounded-full bg-brand-100 dark:bg-brand-950 text-brand-700 dark:text-brand-300">
                  {jobs.length} tin
                </span>
              </h2>
            </div>
            ...
            {jobs.length === 0 ? (
              <div className="bg-white dark:bg-ink-900 p-8 rounded-2xl border border-ink-200 dark:border-ink-800 text-center space-y-3">
                <Briefcase className="w-12 h-12 text-ink-300 mx-auto" />
                <p className="font-bold text-ink-700 dark:text-ink-300 text-sm">Chưa có tin tuyển dụng nào phù hợp với bộ lọc hiện tại.</p>
                <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {jobsPager.pageItems.map(job => (
                  <div
                    key={job.id}
                    className="bg-white dark:bg-ink-900 p-4 sm:p-5 rounded-2xl border border-ink-200 dark:border-ink-800 hover:border-brand-500 dark:hover:border-brand-500 transition shadow-xs hover:shadow-md flex flex-col justify-between group"
                  >
                    <div className="space-y-3">
                      ...
                      <div className="flex items-start justify-between gap-2">
                        <div className="flex flex-wrap items-center gap-1.5">
                          {job.isVip && (
                            <span className="px-2 py-0.5 rounded-full text-[10px] font-black bg-brand-500 text-ink-950 uppercase tracking-wider flex items-center gap-1 shadow-2xs">
                          ...
                          <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-ink-100 dark:bg-ink-800 text-ink-600 dark:text-ink-300">
                            {job.jobType === 'full-time' ? 'Toàn thời gian' : job.jobType === 'part-time' ? 'Bán thời gian' : job.jobType === 'shift' ? 'Làm theo ca' : 'Freelance'}
                          </span>
                        </div>

                        <div className="text-[11px] text-ink-400 font-medium whitespace-nowrap">
                      ...
                      <div>
                        <h3 
                          ...
                          className="font-black text-sm sm:text-base text-ink-900 dark:text-white group-hover:text-brand-600 dark:group-hover:text-brand-400 transition cursor-pointer line-clamp-2 leading-snug"
                        >
                          {job.title}
                        </h3>
                        <div className="flex items-center gap-1.5 text-xs text-ink-500 dark:text-ink-400 mt-1 font-semibold">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-2 border-t border-ink-100 dark:border-ink-800 text-xs">
                        <div className="flex items-center gap-1.5 font-black text-brand-600 dark:text-brand-400">
                          <DollarSign className="w-3.5 h-3.5 shrink-0" />
                          <span className="truncate">{job.salaryDisplay}</span>
                        </div>
                        <div className="flex items-center gap-1.5 text-ink-500 dark:text-ink-400 font-medium">
                    ...
                    {/* Footer Actions */}
                    <div className="pt-3 mt-3 border-t border-ink-100 dark:border-ink-800 flex items-center justify-between gap-2">
                      <div className="text-[11px] text-ink-400">
                        <span>{job.viewsCount || 0} xem</span> • <span className="font-bold text-brand-600 dark:text-brand-400">{job.applicationsCount || 0} ứng tuyển</span>
                      </div>

                      <div className="flex items-center gap-1.5">
                        <button
                          onClick={() => navigate(getJobDetailUrl(job))}
                          className="px-3 py-1.5 bg-ink-100 dark:bg-ink-800 hover:bg-ink-200 text-ink-800 dark:text-ink-200 rounded-xl text-xs font-bold transition cursor-pointer"
                        >
                          Chi Tiết
                        </button>
                        <button
                          onClick={() => navigate(getJobDetailUrl(job))}
                          className="px-3.5 py-1.5 bg-brand-600 hover:bg-brand-500 text-white rounded-xl text-xs font-black transition shadow-xs flex items-center gap-1 cursor-pointer"
                        >
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-ink-500 mt-0.5">Nhà tuyển dụng có thể lọc hồ sơ theo chuyên môn và mở khóa để xem đầy đủ Số điện thoại, Zalo, Email.</p>
              </div>
            </div>

            {candidates.length === 0 ? (
              <div className="bg-white dark:bg-ink-900 p-8 rounded-2xl border border-ink-200 dark:border-ink-800 text-center space-y-3">
                <Users className="w-12 h-12 text-ink-300 mx-auto" />
                <p className="font-bold text-ink-700 dark:text-ink-300 text-sm">Chưa có hồ sơ ứng viên nào phù hợp.</p>
                <button
                  onClick={() => { setSelectedIndustry('all'); setSelectedProject('all'); setSearchQuery(''); }}
                  className="px-4 py-2 bg-brand-600 text-white rounded-xl text-xs font-bold"
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {candidates.map(cand => {
                  ...
                  return (
                    <div
                      key={cand.id}
                      className="bg-white dark:bg-ink-900 p-4 sm:p-5 rounded-2xl border border-ink-200 dark:border-ink-800 hover:border-brand-500 transition shadow-xs flex flex-col justify-between relative group"
                    >
                      <div className="space-y-3">
                        ...
                        <div className="flex items-start gap-3">
                          <img loading="lazy"
                            src={cand.avatarUrl || ''}
                            alt={cand.fullName}
                            className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl object-cover border border-ink-200 dark:border-ink-700 shrink-0"
                          />
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-1.5 flex-wrap">
                              <h3 
                                onClick={() => navigate(getCandidateCvUrl(cand))}
                                className="font-black text-sm sm:text-base text-ink-900 dark:text-white hover:text-brand-600 transition cursor-pointer truncate"
                              >
                                {cand.fullName}
                              </h3>
                              {cand.isImmediate && (
                                <span className="px-1.5 py-0.5 rounded text-[9px] font-black bg-brand-100 dark:bg-brand-950 text-brand-700 dark:text-brand-300">
                                  Sẵn sàng đi làm
                                </span>
                              )}
                            </div>
                        ...
                        <div className="grid grid-cols-2 gap-1.5 bg-ink-50 dark:bg-ink-800/60 p-2.5 rounded-xl text-xs">
                          <div>
                            <span className="text-[10px] text-ink-400 block font-medium">Kinh nghiệm:</span>
                          ...
                          <div>
                            <span className="text-[10px] text-ink-400 block font-medium">Lương kỳ vọng:</span>
                        ...
                        {cand.skills && cand.skills.length > 0 && (
                          <div className="flex flex-wrap gap-1">
                            {cand.skills.slice(0, 3).map((skill, idx) => (
                              <span key={idx} className="px-2 py-0.5 bg-ink-100 dark:bg-ink-800 text-ink-600 dark:text-ink-300 rounded-md text-[10px] font-medium">
                                #{skill}
                              </span>
                            ))}
                            {cand.skills.length > 3 && (
                              <span className="px-1.5 py-0.5 text-[10px] text-ink-400">+{cand.skills.length - 3}</span>
                            )}
                          </div>
                        )}
                        ...
                        <div className={`p-2.5 rounded-xl border text-xs space-y-1 ${
                          isUnlocked 
                            ? 'bg-brand-50/80 dark:bg-brand-950/40 border-brand-300 dark:border-brand-800 text-brand-900 dark:text-brand-200' 
                            : 'bg-ink-100/80 dark:bg-ink-800/80 border-dashed border-ink-300 dark:border-ink-700 text-ink-600 dark:text-ink-400'
                        }`}>
                          <div className="flex items-center justify-between">
                            <span className="font-bold flex items-center gap-1">
                              {isUnlocked ? <Unlock className="w-3.5 h-3.5 text-brand-600" /> : <Lock className="w-3.5 h-3.5 text-brand-500" />}
                              {isUnlocked ? 'Thông tin liên hệ đã mở:' : 'Thông tin liên hệ (Bị khóa):'}
                            </span>
                            {isUnlocked ? (
                              <span className="text-[10px] font-extrabold text-brand-700 bg-brand-200/60 px-1.5 py-0.5 rounded">ĐÃ MỞ KHÓA</span>
                            ) : (
                              <span className="text-[10px] font-bold text-brand-600 dark:text-brand-400">50.000đ / CV</span>
                            )}
                          </div>
                      ...
                      <div className="pt-3 mt-3 border-t border-ink-100 dark:border-ink-800 flex items-center justify-between gap-2">
                        ...
                        {isUnlocked ? (
                          <a
                            href={`tel:${cand.phone}`}
                            className="px-3.5 py-1.5 bg-brand-600 hover:bg-brand-500 text-white rounded-xl text-xs font-black flex items-center gap-1 shadow-xs"
                          >
                          ...
                          <button
                            ...
                            className="px-3.5 py-1.5 bg-brand-500 hover:bg-brand-400 text-ink-950 rounded-xl text-xs font-black flex items-center gap-1 shadow-xs"
                          >
        ...
        {activeTab === 'my_cv' && (
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            {/* CV Header Bar */}
            <div className="bg-white dark:bg-ink-900 p-5 rounded-2xl border border-ink-200 dark:border-ink-800 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
              ...
              <div className="flex items-center gap-2">
                <label className="flex items-center gap-2 cursor-pointer bg-ink-50 dark:bg-ink-800 px-3 py-1.5 rounded-xl border border-ink-200 dark:border-ink-700">
                  <input
                    type="checkbox"
                  ...
                  />
                  <span className="text-xs font-bold text-ink-800 dark:text-ink-200">Bật tìm việc</span>
                </label>

                <button
                  onClick={handleSaveCvSubmit}
                  disabled={isSavingCv}
                  className="px-4 py-2 bg-brand-600 hover:bg-brand-500 text-white rounded-xl text-xs font-black shadow-xs flex items-center gap-1.5 transition"
                >
            ...
            {cvSaveToast && (
              <div className="p-4 bg-brand-100 dark:bg-brand-950 text-brand-800 dark:text-brand-200 rounded-2xl border border-brand-300 dark:border-brand-800 text-xs font-bold flex items-center gap-2">
            ...
            <form onSubmit={handleSaveCvSubmit} className="space-y-6">
              ...
              <div className="bg-white dark:bg-ink-900 p-5 rounded-2xl border border-ink-200 dark:border-ink-800 shadow-xs space-y-4">
                <div className="text-sm font-black text-ink-900 dark:text-white border-b border-ink-100 dark:border-ink-800 pb-2 flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                  <div>
                    <label className="block text-xs font-bold text-ink-700 dark:text-ink-300 mb-1">Họ và Tên *</label>
                    <input
                      type="text"
                      value={myCv.fullName}
                      onChange={(e) => setMyCv(prev => ({ ...prev, fullName: e.target.value }))}
                      placeholder="Ví dụ: Nguyễn Văn An"
                      className="w-full px-3 py-2 bg-ink-50 dark:bg-ink-800 border border-ink-200 dark:border-ink-700 rounded-xl text-xs font-medium focus:ring-2 focus:ring-brand-500 outline-hidden"
                      required
                    />
                  </div>

                  <div>
                    <label className="block text-xs font-bold text-ink-700 dark:text-ink-300 mb-1">Số Điện Thoại / Zalo *</label>
                    <input
                      type="tel"
                      value={myCv.phone}
                  ...
                  <div>
                    <label className="block text-xs font-bold text-ink-700 dark:text-ink-300 mb-1">Email</label>
                    <input
                      type="email"
                      value={myCv.email}
                  ...
                  <div>
                    <label className="block text-xs font-bold text-ink-700 dark:text-ink-300 mb-1">Năm Sinh</label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label className="block text-xs font-bold text-ink-700 dark:text-ink-300 mb-1">Khu Đô Thị / Dự Án</label>
                    <select
                  ...
                  <div>
                    <label className="block text-xs font-bold text-ink-700 dark:text-ink-300 mb-1">Tòa Nhà / Căn Hộ Cụ Thể</label>
                    <input
                      type="text"
              ...
              <div className="bg-white dark:bg-ink-900 p-5 rounded-2xl border border-ink-200 dark:border-ink-800 shadow-xs space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    <label className="block text-xs font-bold text-ink-700 dark:text-ink-300 mb-1">Vị Trí / Chức Danh Ứng Tuyển *</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-xs font-bold text-ink-700 dark:text-ink-300 mb-1">Ngành Nghề Chính *</label>
                    <select
                  ...
                  <div>
                    <label className="block text-xs font-bold text-ink-700 dark:text-ink-300 mb-1">Mức Lương Kỳ Vọng</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-xs font-bold text-ink-700 dark:text-ink-300 mb-1">Kinh Nghiệm Làm Việc</label>
                    <select
                ...
                <div>
                  <label className="block text-xs font-bold text-ink-700 dark:text-ink-300 mb-1">Giới Thiệu Bản Thân & Mục Tiêu Nghề Nghiệp</label>
                  <textarea
                    rows={3}
              ...
              <div className="bg-white dark:bg-ink-900 p-5 rounded-2xl border border-ink-200 dark:border-ink-800 shadow-xs space-y-3">
                <div className="text-sm font-black text-ink-900 dark:text-white border-b border-ink-100 dark:border-ink-800 pb-2 flex items-center gap-2">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2 bg-ink-50 dark:bg-ink-800 border border-ink-200 dark:border-ink-700 rounded-xl text-xs font-medium focus:ring-2 focus:ring-brand-500 outline-hidden"
                  />
                  <button
                    type="button"
                ...
                <div className="flex flex-wrap gap-1.5 pt-2">
                  {myCv.skills.map((skill, idx) => (
                    <span
                      key={idx}
                      className="px-3 py-1 bg-brand-50 dark:bg-brand-950 text-brand-700 dark:text-brand-300 rounded-xl text-xs font-bold border border-brand-200 dark:border-brand-800 flex items-center gap-1.5"
                    >
                      <span>{skill}</span>
                      <button
                        type="button"
              ...
              <div className="bg-white dark:bg-ink-900 p-5 rounded-2xl border border-ink-200 dark:border-ink-800 shadow-xs space-y-4">
                <div className="text-sm font-black text-ink-900 dark:text-white border-b border-ink-100 dark:border-ink-800 pb-2 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <Building2 className="w-4 h-4 text-brand-600" />
                    <span>4. LỊCH SỬ KINH NGHIỆM LÀM VIỆC</span>
                  </div>
                  <span className="text-xs text-ink-400 font-normal">{myCv.workExperience.length} mục</span>
                </div>

                {/* Existing Exp list */}
                {myCv.workExperience.map((exp, idx) => (
                  <div key={idx} className="p-3 bg-ink-50 dark:bg-ink-800/80 rounded-xl border border-ink-200 dark:border-ink-700 relative space-y-1">
                    <button
                      type="button"
                      onClick={() => setMyCv(prev => ({ ...prev, workExperience: prev.workExperience.filter((_, i) => i !== idx) }))}
                      className="absolute top-2.5 right-2.5 text-ink-400 hover:text-rose-600"
                    >
                      <X className="w-4 h-4" />
                    </button>
                    <div className="font-bold text-xs text-ink-900 dark:text-white">{exp.role} - <span className="text-brand-600">{exp.company}</span></div>
                    <div className="text-[11px] text-ink-400">{exp.period}</div>
                    <p className="text-xs text-ink-600 dark:text-ink-300">{exp.description}</p>
                  </div>
                ))}

                {/* Add new Exp sub-form */}
                <div className="p-3 bg-brand-50/40 dark:bg-brand-950/20 rounded-xl border border-dashed border-brand-300 dark:border-brand-800 space-y-2">
                  <div className="text-xs font-bold text-brand-800 dark:text-brand-300">+ Thêm kinh nghiệm làm việc:</div>
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                    <input
                      ...
                      className="px-3 py-1.5 bg-white dark:bg-ink-800 border border-ink-200 dark:border-ink-700 rounded-lg text-xs"
                    />
                    <input
                      type="text"
                      value={newExp.role}
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-1.5 bg-white dark:bg-ink-800 border border-ink-200 dark:border-ink-700 rounded-lg text-xs"
                  />
                  <button
                    type="button"
              ...
              <div className="flex justify-end">
                <button
                  type="submit"
                  disabled={isSavingCv}
                  className="px-6 py-3 bg-brand-600 hover:bg-brand-500 text-white rounded-xl text-sm font-black shadow-lg flex items-center gap-2"
                >
          ...
          <div className="space-y-6">
            <div className="bg-white dark:bg-ink-900 p-5 rounded-2xl border border-ink-200 dark:border-ink-800 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="px-2.5 py-0.5 rounded-full text-xs font-black bg-brand-500/20 text-brand-700 dark:text-brand-300 border border-brand-500/30">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-4 py-2.5 bg-brand-500 hover:bg-brand-400 text-ink-950 rounded-xl text-xs font-black shadow-md flex items-center gap-1.5 cursor-pointer"
                >
                  <PlusCircle className="w-4 h-4" />
            ...
            <div className="bg-white dark:bg-ink-900 p-5 rounded-2xl border border-ink-200 dark:border-ink-800 shadow-xs space-y-4">
              <div className="text-sm font-black text-ink-900 dark:text-white border-b border-ink-100 dark:border-ink-800 pb-2 flex items-center justify-between">
                ...
                <span className="text-[11px] text-ink-400 font-normal">Tự do bật/tắt hoặc chỉnh sửa tin đăng</span>
              </div>

              {jobs.filter(j => j.employerUserId === currentUser?.id).length === 0 ? (
                <div className="text-center py-8 text-ink-400 text-xs">
                  <Briefcase className="w-8 h-8 text-ink-300 dark:text-ink-600 mx-auto mb-2 opacity-50" />
                ...
                <div className="space-y-3">
                  {jobs.filter(j => j.employerUserId === currentUser?.id).map(job => (
                    <div key={job.id} className="p-4 bg-ink-50 dark:bg-ink-800/80 rounded-2xl border border-ink-200 dark:border-ink-700 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                      <div>
                        <div className="flex items-center gap-2">
                          <span className={`px-2 py-0.5 rounded-full text-[10px] font-black ${
                            job.status === 'active' ? 'bg-brand-100 text-brand-700 dark:bg-brand-950 dark:text-brand-300' : 'bg-ink-200 text-ink-700 dark:bg-ink-700 dark:text-ink-300'
                          }`}>
                            {job.status === 'active' ? '● Đang Tuyển' : '○ Tạm Dừng'}
                          </span>
                          {job.isVip && <span className="px-2 py-0.5 rounded-full text-[10px] font-black bg-brand-500 text-ink-950">VIP Diamond</span>}
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-xl text-xs font-bold transition cursor-pointer ${
                            job.status === 'active' ? 'bg-ink-200 dark:bg-ink-700 hover:bg-ink-300 text-ink-800 dark:text-ink-200' : 'bg-brand-600 hover:bg-brand-500 text-white'
                          }`}
                        >
                        ...
                        <button
                          ...
                          className="p-1.5 text-ink-400 hover:text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-950/30 rounded-xl transition cursor-pointer"
              ...
              {applications.length === 0 ? (
                ...
                <div className="space-y-3">
                  {applications.map(app => (
                    <div key={app.id} className="p-3.5 bg-ink-50 dark:bg-ink-800/80 rounded-xl border border-ink-200 dark:border-ink-700 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                      <div>
                        <div className="font-bold text-xs text-ink-900 dark:text-white">{app.candidateName} - <span className="text-brand-600">{app.candidatePhone}</span></div>
                        <div className="text-[11px] text-ink-500">Ứng tuyển vị trí: <span className="font-semibold text-ink-700 dark:text-ink-300">{app.jobTitle}</span></div>
                        {app.message && <p className="text-xs text-ink-600 dark:text-ink-400 mt-1 italic">"{app.message}"</p>}
                      </div>

                      <div className="flex items-center gap-2">
                        <a
                          href={`tel:${app.candidatePhone}`}
                          className="px-3 py-1.5 bg-brand-600 hover:bg-brand-500 text-white rounded-lg text-xs font-bold flex items-center gap-1"
                        >
                          <Phone className="w-3 h-3" />
                          <span>Gọi Điện</span>
                        </a>
      ...
      {isPostJobModalOpen && (
        <div className="fixed inset-0 z-50 bg-ink-950/70 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white dark:bg-ink-900 rounded-3xl border border-ink-200 dark:border-ink-800 shadow-2xl max-w-2xl w-full p-5 sm:p-6 space-y-4 my-8">
            <div className="flex items-center justify-between border-b border-ink-100 dark:border-ink-800 pb-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="text-base font-black text-ink-900 dark:text-white">Đăng Tin Tuyển Dụng Mới</h3>
                  <p className="text-[11px] text-ink-400">Tiếp cận hàng vạn cư dân sinh sống trong khu đô thị</p>
                </div>
              </div>
              <button onClick={() => setIsPostJobModalOpen(false)} className="text-ink-400 hover:text-ink-600 p-1 cursor-pointer">
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="space-y-2">
              <label className="block text-xs font-black text-ink-900 dark:text-white">Chọn Gói Đăng Tin Tuyển Dụng:</label>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                {/* Standard */}
                <button
                  type="button"
                ...
                >
                  <div className="font-black text-xs text-ink-900 dark:text-white">GÓI TIÊU CHUẨN</div>
                  <div className="text-brand-600 font-extrabold text-sm mt-0.5">20.000 Token</div>
                  <div className="text-[10px] text-ink-400 mt-1">Hiển thị 30 ngày trên cổng việc làm</div>
                </button>
                ...
                >
                  ...
                  <div className="text-[10px] text-ink-400 mt-1">Gắn nhãn Tuyển Gấp màu đỏ nổi bật</div>
                </button>
                ...
                >
                  <div className="font-black text-xs text-brand-600"> VIP DIAMOND</div>
                  <div className="text-brand-600 font-extrabold text-sm mt-0.5">50.000 Token</div>
                  <div className="text-[10px] text-ink-400 mt-1">Ghim Top 1 vị trí kim cương</div>
                </button>
              </div>

              {/* Token balance summary */}
              <div className="p-2.5 bg-brand-50 dark:bg-brand-950/40 rounded-xl border border-brand-200 dark:border-brand-800 flex items-center justify-between text-xs">
                <span className="text-ink-600 dark:text-ink-300">
                  Số dư Token Cư Dân của bạn: <strong className="text-brand-600 dark:text-brand-400 font-black">{(currentUser?.tokenBalance ?? currentUser?.balance ?? 0).toLocaleString('vi-VN')} Token</strong>
                </span>
                <span className="text-[10px] text-ink-400">
                  {currentUser?.role === 'admin' ? ' Admin: Miễn phí' : '(1 Token = 1 VNĐ)'}
                </span>
              </div>
            </div>
            ...
            <form onSubmit={handlePostJobSubmit} className="space-y-3">
              <div>
                <label className="block text-xs font-bold text-ink-700 dark:text-ink-300 mb-1">Tiêu Đề Tin Tuyển Dụng *</label>
                <input
                  type="text"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-bold text-ink-700 dark:text-ink-300 mb-1">Tên Công Ty / Cửa Hàng / Chủ Nhà *</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-xs font-bold text-ink-700 dark:text-ink-300 mb-1">Ngành Nghề Tuyển Dụng *</label>
                  <select
                ...
                <div>
                  <label className="block text-xs font-bold text-ink-700 dark:text-ink-300 mb-1">Địa Chỉ Chi Tiết Nơi Làm Việc</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-xs font-bold text-ink-700 dark:text-ink-300 mb-1">Mức Lương Hiển Thị *</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-xs font-bold text-ink-700 dark:text-ink-300 mb-1">Hình Thức Làm Việc</label>
                  <select
              ...
              <div>
                <label className="block text-xs font-bold text-ink-700 dark:text-ink-300 mb-1">Mô Tả Công Việc</label>
                <textarea
                  rows={3}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-bold text-ink-700 dark:text-ink-300 mb-1">Yêu Cầu (Mỗi dòng 1 ý)</label>
                  <textarea
                    rows={2}
                ...
                <div>
                  <label className="block text-xs font-bold text-ink-700 dark:text-ink-300 mb-1">Quyền Lợi & Đãi Ngộ (Mỗi dòng 1 ý)</label>
                  <textarea
                    rows={2}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 border-t border-ink-100 dark:border-ink-800">
                <div>
                  <label className="block text-xs font-bold text-ink-700 dark:text-ink-300 mb-1">Người Liên Hệ *</label>
                  <input
                    type="text"
              ...
              <div className="flex items-center justify-end gap-2 pt-3 border-t border-ink-100 dark:border-ink-800">
                <button
                  ...
                  className="px-4 py-2 bg-ink-100 dark:bg-ink-800 text-ink-700 dark:text-ink-300 rounded-xl text-xs font-bold"
                >
                  Hủy Bỏ
                </button>
                <button
                  ...
                  className="px-5 py-2 bg-brand-500 hover:bg-brand-400 text-ink-950 rounded-xl text-xs font-black shadow-md flex items-center gap-1.5"
                >
                  <Check className="w-4 h-4" />
      ...
      {selectedJobModal && !isApplyModalOpen && (
        <div className="fixed inset-0 z-50 bg-ink-950/70 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white dark:bg-ink-900 rounded-3xl border border-ink-200 dark:border-ink-800 shadow-2xl max-w-2xl w-full p-5 sm:p-6 space-y-4 my-8">
            <div className="flex items-start justify-between border-b border-ink-100 dark:border-ink-800 pb-3 gap-2">
              <div>
                <div className="flex items-center gap-1.5 mb-1">
                  {selectedJobModal.isVip && (
                    <span className="px-2 py-0.5 rounded-full text-[10px] font-black bg-brand-500 text-ink-950">VIP</span>
                  )}
                  ...
                  <span className="text-xs text-ink-400">{selectedJobModal.projectName}</span>
                </div>
                <h3 className="text-base sm:text-lg font-black text-ink-900 dark:text-white">
                  {selectedJobModal.title}
                </h3>
                <div className="text-xs font-bold text-brand-600 dark:text-brand-400 mt-1">
                  {selectedJobModal.companyName}
                </div>
              </div>
              <button onClick={() => setSelectedJobModal(null)} className="text-ink-400 hover:text-ink-600 p-1">
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 bg-ink-50 dark:bg-ink-800 p-3 rounded-2xl text-xs">
              ...
              <div>
                <span className="text-[10px] text-ink-400 block font-medium">Kinh nghiệm:</span>
                <span className="font-bold text-ink-800 dark:text-ink-200">{selectedJobModal.experienceDisplay}</span>
              </div>
            </div>

            {/* Description */}
            <div className="space-y-2 text-xs">
              <h4 className="font-black text-ink-900 dark:text-white uppercase tracking-wider text-[11px]">Mô Tả Công Việc</h4>
              <p className="text-ink-600 dark:text-ink-300 whitespace-pre-line leading-relaxed">{selectedJobModal.description}</p>
            </div>

            {/* Requirements */}
            {selectedJobModal.requirements && selectedJobModal.requirements.length > 0 && (
              <div className="space-y-1.5 text-xs">
                <h4 className="font-black text-ink-900 dark:text-white uppercase tracking-wider text-[11px]">Yêu Cầu Ứng Viên</h4>
                <ul className="list-disc pl-5 space-y-1 text-ink-600 dark:text-ink-300">
            ...
            {selectedJobModal.benefits && selectedJobModal.benefits.length > 0 && (
              <div className="space-y-1.5 text-xs">
                <h4 className="font-black text-ink-900 dark:text-white uppercase tracking-wider text-[11px]">Quyền Lợi & Đãi Ngộ</h4>
                <ul className="list-disc pl-5 space-y-1 text-ink-600 dark:text-ink-300">
            ...
            {/* Contact Box */}
            <div className="p-3 bg-brand-50 dark:bg-brand-950/60 rounded-2xl border border-brand-200 dark:border-brand-800 flex items-center justify-between gap-3 text-xs">
              <div>
                <div className="font-bold text-brand-900 dark:text-brand-200">Liên hệ trực tiếp: {selectedJobModal.contactName}</div>
                <div className="font-mono text-brand-700 dark:text-brand-300 font-bold">{selectedJobModal.contactPhone}</div>
              </div>
              <a
                href={`tel:${selectedJobModal.contactPhone}`}
                className="px-3 py-1.5 bg-brand-600 hover:bg-brand-500 text-white rounded-xl font-bold flex items-center gap-1 shrink-0"
              >
            ...
            <div className="flex items-center justify-end gap-2 pt-2 border-t border-ink-100 dark:border-ink-800">
              ...
              <button
                ...
                className="px-5 py-2 bg-brand-600 hover:bg-brand-500 text-white rounded-xl text-xs font-black shadow-md flex items-center gap-1.5"
              >
      ...
      {isApplyModalOpen && selectedJobModal && (
        <div className="fixed inset-0 z-50 bg-ink-950/70 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white dark:bg-ink-900 rounded-3xl border border-ink-200 dark:border-ink-800 shadow-2xl max-w-lg w-full p-5 sm:p-6 space-y-4 my-8">
            <div className="flex items-center justify-between border-b border-ink-100 dark:border-ink-800 pb-3">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-xl bg-brand-500/20 text-brand-600 flex items-center justify-center">
                  <Send className="w-4 h-4" />
                </div>
                <div>
                  <h3 className="text-sm font-black text-ink-900 dark:text-white">Nộp Hồ Sơ Ứng Tuyển</h3>
                  <p className="text-[11px] text-ink-400 truncate max-w-xs">{selectedJobModal.title}</p>
                </div>
              </div>
              <button onClick={() => setIsApplyModalOpen(false)} className="text-ink-400 hover:text-ink-600 p-1">
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <form onSubmit={handleApplySubmit} className="space-y-3 text-xs">
              <div>
                <label className="block font-bold text-ink-700 dark:text-ink-300 mb-1">Họ và Tên của bạn *</label>
                <input
                  type="text"
                  value={applyCandidateName}
                  onChange={(e) => setApplyCandidateName(e.target.value)}
                  placeholder="Ví dụ: Nguyễn Văn An"
                  className="w-full px-3 py-2 bg-ink-50 dark:bg-ink-800 border border-ink-200 dark:border-ink-700 rounded-xl font-medium focus:ring-2 focus:ring-brand-500 outline-hidden"
                  required
                />
              </div>

              <div>
                <label className="block font-bold text-ink-700 dark:text-ink-300 mb-1">Số Điện Thoại Nhận Cuộc Gọi Phỏng Vấn *</label>
                <input
                  type="tel"
              ...
              <div>
                <label className="block font-bold text-ink-700 dark:text-ink-300 mb-1">Mức Lương Mong Muốn</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block font-bold text-ink-700 dark:text-ink-300 mb-1">Lời Nhắn Gửi Nhà Tuyển Dụng</label>
                <textarea
                  rows={3}
                  value={applyMessage}
              ...
              <div className="flex items-center justify-end gap-2 pt-3 border-t border-ink-100 dark:border-ink-800">
                <button
                  ...
                  className="px-4 py-2 bg-ink-100 dark:bg-ink-800 text-ink-700 dark:text-ink-300 rounded-xl font-bold"
                >
                  Hủy
                </button>
                <button
                  ...
                  className="px-5 py-2 bg-brand-600 hover:bg-brand-500 text-white rounded-xl font-black shadow-md flex items-center gap-1"
                >
      ...
      {isUnlockModalOpen && candidateToUnlock && (
        <div className="fixed inset-0 z-50 bg-ink-950/70 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white dark:bg-ink-900 rounded-3xl border border-ink-200 dark:border-ink-800 shadow-2xl max-w-md w-full p-5 sm:p-6 space-y-4 my-8">
            <div className="flex items-center justify-between border-b border-ink-100 dark:border-ink-800 pb-3">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-xl bg-brand-500/20 text-brand-600 flex items-center justify-center">
                ...
                <div>
                  <h3 className="text-sm font-black text-ink-900 dark:text-white">Mở Khóa Hồ Sơ Ứng Viên</h3>
                  <p className="text-[11px] text-ink-400">Xem đầy đủ SĐT, Zalo & Liên hệ trực tiếp</p>
                </div>
              </div>
              <button onClick={() => setIsUnlockModalOpen(false)} className="text-ink-400 hover:text-ink-600 p-1">
                <X className="w-5 h-5" />
              </button>
            </div>

            {/* Candidate Summary */}
            <div className="flex items-center gap-3 p-3 bg-ink-50 dark:bg-ink-800 rounded-2xl">
              <img loading="lazy"
              ...
              <div className="min-w-0">
                <div className="font-black text-sm text-ink-900 dark:text-white truncate">{candidateToUnlock.fullName}</div>
                <div className="text-xs font-bold text-brand-600 dark:text-brand-400 truncate">{candidateToUnlock.targetJobTitle}</div>
                <div className="text-[11px] text-ink-400 truncate">{candidateToUnlock.projectName}</div>
              </div>
            </div>

            {/* Fee & VietQR */}
            <div className="bg-brand-50 dark:bg-brand-950/40 p-4 rounded-2xl border border-brand-200 dark:border-brand-800 text-center space-y-2">
              <div className="text-xs text-brand-900 dark:text-brand-300 font-medium">Phí mở khóa xem trọn vẹn CV:</div>
              ...
              <div className="text-[11px] text-ink-500">Mở khóa 1 lần xem vĩnh viễn trong danh sách của bạn</div>
            </div>

            {/* QR Scan Code Preview */}
            <div className="text-center space-y-2">
              <div className="inline-block p-2 bg-white rounded-2xl border border-ink-200 shadow-xs">
                <img loading="lazy"
              ...
              <div className="text-[11px] text-ink-400">Quét mã VietQR bằng bất kỳ App Ngân Hàng hoặc nhấn Xác Nhận bên dưới</div>
            </div>
        ...
        <div className="fixed inset-0 z-50 bg-ink-950/70 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white dark:bg-ink-900 rounded-3xl border border-ink-200 dark:border-ink-800 shadow-2xl max-w-2xl w-full p-5 sm:p-6 space-y-4 my-8">
            <div className="flex items-start justify-between border-b border-ink-100 dark:border-ink-800 pb-3 gap-2">
              ...
              <button onClick={() => setSelectedCandidateModal(null)} className="text-ink-400 hover:text-ink-600 p-1">
                <X className="w-5 h-5" />
              </button>
            </div>

            {/* Quick stats */}
            <div className="grid grid-cols-3 gap-2 bg-ink-50 dark:bg-ink-800 p-3 rounded-2xl text-xs">
              <div>
                <span className="text-[10px] text-ink-400 block font-medium">Lương kỳ vọng:</span>
                <span className="font-bold text-brand-600 dark:text-brand-400">{selectedCandidateModal.expectedSalary}</span>
              </div>
              <div>
                <span className="text-[10px] text-ink-400 block font-medium">Kinh nghiệm:</span>
                <span className="font-bold text-ink-800 dark:text-ink-200">
              ...
              <div>
                <span className="text-[10px] text-ink-400 block font-medium">Trạng thái:</span>
                <span className="font-bold text-brand-600">Sẵn sàng nhận việc</span>
              </div>
            </div>

            {/* Bio */}
            <div className="space-y-1.5 text-xs">
              <h4 className="font-black text-ink-900 dark:text-white uppercase tracking-wider text-[11px]">Giới Thiệu Bản Thân</h4>
              <p className="text-ink-600 dark:text-ink-300 leading-relaxed">{selectedCandidateModal.introduction}</p>
            </div>

            {/* Skills */}
            {selectedCandidateModal.skills && selectedCandidateModal.skills.length > 0 && (
              <div className="space-y-1.5 text-xs">
                <h4 className="font-black text-ink-900 dark:text-white uppercase tracking-wider text-[11px]">Kỹ Năng & Thế Mạnh</h4>
                <div className="flex flex-wrap gap-1.5">
                  {selectedCandidateModal.skills.map((s, i) => (
                    <span key={i} className="px-2.5 py-1 bg-brand-50 dark:bg-brand-950 text-brand-700 dark:text-brand-300 rounded-lg text-xs font-bold border border-brand-200">
                      {s}
                    </span>
                  ))}
                </div>
            ...
            {selectedCandidateModal.workExperience && selectedCandidateModal.workExperience.length > 0 && (
              <div className="space-y-2 text-xs">
                <h4 className="font-black text-ink-900 dark:text-white uppercase tracking-wider text-[11px]">Kinh Nghiệm Làm Việc</h4>
                <div className="space-y-2">
                  {selectedCandidateModal.workExperience.map((exp, i) => (
                    <div key={i} className="p-3 bg-ink-50 dark:bg-ink-800 rounded-xl border">
                      <div className="font-bold text-ink-900 dark:text-white">{exp.role} - <span className="text-brand-600">{exp.company}</span></div>
                      <div className="text-[10px] text-ink-400">{exp.period}</div>
                      <p className="text-xs text-ink-600 dark:text-ink-300 mt-1">{exp.description}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className={`p-4 rounded-2xl border text-xs space-y-2 ${
              (selectedCandidateModal as any).isUnlocked 
                ? 'bg-brand-50 dark:bg-brand-950/60 border-brand-300 dark:border-brand-800 text-brand-900 dark:text-brand-200' 
                : 'bg-ink-100 dark:bg-ink-800 border-dashed border-ink-300 dark:border-ink-700'
            }`}>
              <div className="flex items-center justify-between">
                <span className="font-bold flex items-center gap-1.5">
                  {(selectedCandidateModal as any).isUnlocked ? <Unlock className="w-4 h-4 text-brand-600" /> : <Lock className="w-4 h-4 text-brand-500" />}
                  {(selectedCandidateModal as any).isUnlocked ? 'Thông tin liên hệ đã mở khóa:' : 'Thông tin liên hệ (Bị che để bảo mật):'}
                </span>
                {!(selectedCandidateModal as any).isUnlocked && (
                  <span className="text-[10px] font-bold text-brand-600 bg-brand-100 dark:bg-brand-950 px-2 py-0.5 rounded-full">50.000đ / Lượt</span>
                )}
              </div>
            ...
            <div className="flex items-center justify-end gap-2 pt-2 border-t border-ink-100 dark:border-ink-800">
              ...
              {(selectedCandidateModal as any).isUnlocked ? (
                <a
                  ...
                  className="px-5 py-2 bg-brand-600 hover:bg-brand-500 text-white rounded-xl text-xs font-black shadow-md flex items-center gap-1"
                >
