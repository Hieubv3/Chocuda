...
export const PrivacyPolicyPage: React.FC<PrivacyPolicyPageProps> = ({ onBackToHome }) => {
  ...
  return (
    <div className="min-h-screen bg-ink-50 dark:bg-ink-950 text-ink-800 dark:text-ink-200 py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {onBackToHome && (
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-white dark:bg-ink-900 border border-ink-200 dark:border-ink-800 rounded-xl text-xs font-bold text-ink-700 dark:text-ink-300 hover:text-brand-500 transition shadow-xs"
          >
        ...
        {/* Header Hero Banner */}
        <div className="p-8 bg-gradient-to-br from-ink-900 via-ink-950 to-brand-950 border border-ink-800 rounded-3xl text-white shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-4">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-brand-500/20 border border-brand-500/40 rounded-full text-brand-400 text-xs font-black uppercase tracking-wider">
            ...
            <p className="text-xs sm:text-sm text-ink-300 leading-relaxed max-w-2xl">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-4 text-xs text-ink-400 border-t border-ink-800/80">
        ...
        {/* Content Sections */}
        <div className="bg-white dark:bg-ink-900 border border-ink-200 dark:border-ink-800 rounded-3xl p-6 sm:p-10 space-y-8 shadow-sm">
          
          {/* Section 1 */}
          <section className="space-y-3">
            <div className="flex items-center gap-3 text-brand-500 font-black text-lg">
              <div className="w-8 h-8 rounded-xl bg-brand-500/10 flex items-center justify-center text-brand-500 font-bold text-sm">
                1
              </div>
              <h2>Mục Đích Thu Thập Dữ Liệu Cá Nhân</h2>
            </div>
            <p className="text-xs sm:text-sm leading-relaxed text-ink-600 dark:text-ink-300 pl-11">
            ...
            <ul className="list-disc pl-16 text-xs sm:text-sm text-ink-600 dark:text-ink-300 space-y-1.5">
          ...
          <section className="space-y-4 p-6 bg-ink-50 dark:bg-ink-800/50 border border-blue-200 dark:border-blue-900/50 rounded-2xl">
            ...
            <div className="pl-11 space-y-4">
              <div className="p-4 bg-white dark:bg-ink-900 border border-ink-200 dark:border-ink-700 rounded-xl space-y-2">
                <h3 className="text-xs font-bold text-ink-900 dark:text-white flex items-center gap-2">
                ...
                <form onSubmit={handleRequestDataDeletion} className="mt-3 space-y-3">
                  <div className="flex flex-col sm:flex-row gap-2">
                    <input
                      ...
                      className="flex-1 px-4 py-2.5 bg-ink-50 dark:bg-ink-800 border border-ink-300 dark:border-ink-600 rounded-xl text-xs font-medium focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    />
                    <button
                      type="submit"
                  ...
                  {deletionStatus === 'success' && (
                    <div className="p-3 bg-brand-500/10 border border-brand-500/30 rounded-xl text-xs text-brand-800 dark:text-brand-300 leading-relaxed flex items-start gap-2">
              ...
              <div className="p-4 bg-white dark:bg-ink-900 border border-ink-200 dark:border-ink-700 rounded-xl space-y-2">
                ...
                <ol className="list-decimal pl-5 text-xs text-ink-600 dark:text-ink-300 space-y-1">
          ...
          <section className="space-y-3">
            ...
            <div className="pl-11 space-y-2 text-xs sm:text-sm text-ink-600 dark:text-ink-300">
              <p>Nếu bạn có bất kỳ thắc mắc, đóng góp ý kiến hoặc khiếu nại về chính sách bảo mật, vui lòng liên hệ:</p>
              <div className="p-4 bg-ink-50 dark:bg-ink-800/80 rounded-xl space-y-1.5 font-medium border border-ink-200 dark:border-ink-700">
                ...
                <p><strong>Hotline / Zalo:</strong> <a href="tel:0868499929" className="text-brand-500 font-bold underline">0868.499.929</a></p>
