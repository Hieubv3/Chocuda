      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {onBackToHome && (
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-white dark:bg-ink-900 border border-ink-200 dark:border-ink-800 rounded-xl text-xs font-bold text-ink-700 dark:text-ink-300 hover:text-brand-500 transition shadow-xs cursor-pointer"
          >
        ...
        <div className="bg-white dark:bg-ink-900 border border-ink-200 dark:border-ink-800 rounded-3xl p-6 sm:p-10 space-y-8 shadow-sm">
          ...
          <section className="space-y-3">
            ...
            <div className="mt-4 p-4 bg-brand-500/5 dark:bg-brand-500/10 border border-brand-500/20 rounded-2xl space-y-2 text-xs sm:text-sm">
              <p><strong>Ban Quản Trị Chợ Cư Dân 24H</strong></p>
              <p> Email tiếp nhận phản hồi: <a href="mailto:chocudan24h@gmail.com" className="text-brand-600 dark:text-brand-400 font-bold underline">chocudan24h@gmail.com</a></p>
              <p> Hotline hỗ trợ 24/7: <span className="font-bold text-ink-900 dark:text-white">090 999 8888</span></p>
              <p> Website: <a href="https://chocudan24h.com" target="_blank" rel="noreferrer" className="text-brand-600 dark:text-brand-400 font-bold underline">https://chocudan24h.com</a></p>
            </div>
          </section>
