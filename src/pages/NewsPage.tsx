...
export const NewsPage: React.FC<NewsPageProps> = ({ news, language, currentUser, onSelectArticle }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      ...
      <PageBanner
        pageKey="tin-tuc"
        fallbackTitle="BẢN TIN THỊ TRƯỜNG VINHOMES 24/7"
        fallbackSubtitle="Đồng bộ bài viết tự động từ webhook n8n & phân tích từ Gemini AI"
        fallbackImage="/images/demo/hero-skyline.jpg"
      />
